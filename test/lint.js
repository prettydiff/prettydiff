                                    ...
                                    units: [
                                        {
                                            ...
                                            check : "node api/node-local.js source:\"<a><b> <c/>    </b></a>\" readmethod:\"screen\" " +
                                                        "mode:\"parse\"",
                                            name  : "Parse markup.",
                                            verify: "{\"data\":{\"attrs\":[[],[],[],[],[]],\"jscom\":[false,false,false,false,false]," +
                                                        "\"linen\":[1,1,1,1,1],\"lines\":[0,0,1,1,0],\"presv\":[false,false,false,false,f" +
                                                        "alse],\"token\":[\"<a>\",\"<b>\",\"<c/>\",\"</b>\",\"</a>\"],\"types\":[\"start" +
                                                        "\",\"start\",\"singleton\",\"end\",\"end\"]},\"definition\":{\"attrs\":\"array -" +
                                                        " List of attributes (if any) for the given token\",\"jscom\":\"boolean - Whether" +
                                                        " the token is a JavaScript comment if in JSX format\",\"linen\":\"number - The l" +
                                                        "ine number in the original source where the token started, which is used for rep" +
                                                        "orting and analysis\",\"lines\":\"number - Whether the token is preceeded any sp" +
                                                        "ace and/or line breaks in the original code source\",\"presv\":\"boolean - Wheth" +
                                                        "er the token is preserved verbatim as found.  Useful for comments and HTML 'pre'" +
                                                        " tags.\",\"token\":\"string - The parsed code tokens\",\"types\":\"string - Data" +
                                                        " types of the tokens: cdata, comment, conditional, content, end, ignore, linepre" +
                                                        "serve, script, sgml, singleton, start, template, template_else, template_end, te" +
                                                        "mplate_start, xml\"}}"
                                        }, {
                                            check : "node api/node-local.js source:\"<a><b> <c/>    </b></a>\" readmethod:\"screen\" " +
                                    ...
                                    units: [
                                        {
                                            ...
                                            verify: "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><!DOCTYPE html PUBLIC \"-//W3C//DTD X" +
                                                        ...
                                                        "<tr><th>Total Character Size</th><td>56</td><td>66</td><td>10</td><td>17.86%</td" +
                                                        ...
                                                        "td><td>100.00%</td><td>32.14%</td></tr><tr><th>Inline Comments</th><td>0</td><td" +
                                                        ">0.00%</td><td>0.00%</td><td>0</td><td>0.00%</td><td>0.00%</td></tr><tr><th>Comm" +
                                                        "ent Total</th><td>1</td><td>100.00%</td><td>7.69%</td><td>18</td><td>100.00%</td" +
                                                        "><td>32.14%</td></tr><tr><th colspan='7'>Whitespace Outside of Strings and Comme" +
                                                        ...
                                                        "><td>7.69%</td><td>1</td><td>100.00%</td><td>1.79%</td></tr><tr><th>Tabs</th><td" +
                                                        ...
                                                        "td><td>7.69%</td><td>1</td><td>100.00%</td><td>1.79%</td></tr><tr><th colspan='7" +
                                                        ...
                                                        "0%</td><td>7.69%</td><td>8</td><td>100.00%</td><td>14.29%</td></tr><tr><th>Regul" +
                                                        ...
                                                        "9%</td><td>8</td><td>100.00%</td><td>14.29%</td></tr><tr><th colspan='7'>Syntax " +
                                                        ...
                                                        ".38%</td><td>2</td><td>40.00%</td><td>3.57%</td></tr><tr><th>Operators</th><td>3" +
                                                        "</td><td>60.00%</td><td>23.08%</td><td>3</td><td>60.00%</td><td>5.36%</td></tr><" +
                                                        "tr><th>Total Syntax Characters</th><td>5</td><td>100.00%</td><td>38.46%</td><td>" +
                                                        "5</td><td>100.00%</td><td>8.93%</td></tr><tr><th colspan='7'>Keywords and Variab" +
                                                        "les</th></tr><tr><th>Words</th><td>5</td><td>100.00%</td><td>38.46%</td><td>24</" +
                                    ...
                                    units: [
                                        {
                                            ...
                                            verify: "{\"data\":{\"attrs\":[[],[],[],[],[],[]],\"jscom\":[false,false,false,false,fals" +
                                                        "e,false],\"linen\":[1,2,3,3,3,4],\"lines\":[0,1,1,0,0,1],\"presv\":[false,true,f" +
                                                        "alse,false,false,false],\"token\":[\"<person>\",\"<!-- comment -->\",\"<name>\"," +
                                                        "\"bob\",\"</name>\",\"</person>\"],\"types\":[\"start\",\"comment\",\"start\",\"" +
                                                        "content\",\"end\",\"end\"]},\"definition\":{\"attrs\":\"array - List of attribut" +
                                                        "es (if any) for the given token\",\"jscom\":\"boolean - Whether the token is a J" +
                                                        "avaScript comment if in JSX format\",\"linen\":\"number - The line number in the" +
                                                        " original source where the token started, which is used for reporting and analys" +
                                                        "is\",\"lines\":\"number - Whether the token is preceeded any space and/or line b" +
                                                        "reaks in the original code source\",\"presv\":\"boolean - Whether the token is p" +
                                                        "reserved verbatim as found.  Useful for comments and HTML 'pre' tags.\",\"token" +
                                                        "\":\"string - The parsed code tokens\",\"types\":\"string - Data types of the to" +
                                                        "kens: cdata, comment, conditional, content, end, ignore, linepreserve, script, s" +
                                                        "gml, singleton, start, template, template_else, template_end, template_start, xm" +
                                                        "l\"}}"
                                        }
                                    ]
                                }
