                                                ...
                                                groupEnd      = function taskrunner_simulations_shell_child_childExec_writeLine_groupEnd() {
                                                    ...
                                                    if (depth > -1) {
                                                        ...
                                                        if (fails === total) {
                                                            ...
                                                            //a hack, this should not increment when a test failure occurred in a child group
                                                            fgroup -= 1;
                                                            if (fgroup === 1) {
                                                                groupn = "";
                                                            }
