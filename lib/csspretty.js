 ...
 * diffcomm - Tells the application to preserve all comments for the
   ...
   false.
 * vertical - Accepts a boolean that determines if the colons after
   properties should be vertically aligned.
 * alphasort - Accepts a boolean and defaults to false.  If true
   contents in a scope will be sorted by type and then alphabetically.
   Perfectly safe for CSS but considered harmful to LESS and SASS.
 -----------------------------------------------------------------------
 */
var summary = "",
