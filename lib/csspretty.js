                        ...
                        if (b[a] === "\"") {
                            ...
                            if (endlen === end.length) {
                                ...
                                if (open === "{%") {
                                    ...
                                    store = ["autoescape", "block", "capture", "case", "comment", "embed", "filter", "for", "form", "if", "macro", "paginate", "raw", "sandbox", "spaceless", "tablerow", "unless", "verbatim"];
                                    ...
                                    do {
                                        start += 1;
                                    } while (start < endlen && (/\s/).test(name.charAt(start)) === false);
                                    ...
                                    if (name === "block" || name === "define" || name === "if" || name === "range" || name === "with") {
                                        return types.push("external_start");
                                    }
                                }
                ...
                if (types[a] === "start") {
                    ...
                    if (types[a + 1] === "comment-inline") {
                        ...
                        if (options.cssinsertlines === true && types[a + 1] === "selector") {
                            build.push(lf);
                        } else if (lines[a + 1] > 0 || types[a + 1].indexOf("external") < 0) {
                            nl(indent);
                        }
                    }
                    ...
                    if (types[a] === "external_start" && types[a + 1] !== "selector") {
                        ...
                        indent -= 1;
                        if (build[build.length - 1] === tab && (types[a - 1] === "end" || types[a - 1] === "semi")) {
                            build.pop();
                        }
