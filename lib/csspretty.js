...
var csspretty = function csspretty_(options) {
    ...
    if (options.mode !== "minify") {
        output = (function csspretty__beautify() {
            ...
            //beautification loop
            for (a = 0; a < len; a += 1) {
                if (lines[a] > 1 && options.compressedcss === false && (types[a] === "start" || types[a] === "end" || types[a] === "selector" || types[a] === "comment")) {
                ...
                if (types[a] === "start") {
                    ...
                    if (a > 0 && options.compressedcss === true && types[a] === "comment" && types[a - 1] !== "comment") {
                        build.push(lf);
                        nl(indent);
                    } else if (a > 0 && types[a - 1] !== "start" && build[build.length - 1] !== tab && types[a] !== "comment-inline") {
                        nl(indent);
                    }
                    build.push(token[a]);
