            ...
            var a              = 0,
                ...
                strlen         = function jspretty__tokenize_strlen(item) {
                    var aa    = 0,
                        ...
                        slash = function jspretty__tokenize_strlen_slash(offset, entity) {
                            var dist = 0;
                            if (entity === true) {
                                ff = offset;
                            }
                            do {
                                dist += 1;
                            } while (item.charAt(cc - (offset + dist)) === "\\" && dist < cc);
                            if (entity === false) {
                                cc -= dist;
                                ff += dist;
                            } else if (dist % 2 === 1) {
                ...
                var a           = 0,
                    ...
                    separator   = function jspretty__beautify_separator() {
                        ...
                        if (ctoke === ",") {
                            ...
                            if (depth[a] === "method" && options.jsx === false && (types[a - 1] !== "literal" || token[a - 2] !== "+")) {
                                return level.push("s");
                            }
                    ...
                    operator    = function jspretty__beautify_operator() {
                        ...
                        if (ctoke === "+") {
                            if (ltoke.length < options.wrap + 3 && (ltoke.charAt(0) === "\"" || ltoke.charAt(0) === "'") && (token[a + 1].charAt(0) === "\"" || token[a + 1].charAt(0) === "'")) {
                                ...
                                if (list[list.length - 1] === true || token[a - 2] === "return" || (depth[a] === "object" && token[begin[a] - 1] !== "return") || depth[a] === "method" || depth[a] === "global" || (token[begin[a] - 1] !== "return" && (token[a - 1].charAt(0) === "\"" || token[a - 1].charAt(0) === "'") && (token[a - 2] === "+" || token[a - 2].indexOf("=") > -1 || types[a - 2] === "start"))) {
                                    if (superindent === 0) {
