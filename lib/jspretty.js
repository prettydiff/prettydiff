            ...
            (function jspretty__beautify() {
                var a             = 0,
                    ...
                    separator     = function jspretty__beautify_separator() {
                        ...
                        if (ctoke === ".") {
                            if (token[begin[a]] !== "(" && token[begin[a]] !== "x(" && ei !== undefined && ei.length > 0) {
                                if (depth[a] === "object" || depth[a] === "array") {
                                    destructfix(true, false);
                                } else {
                                    destructfix(false, false);
                            ...
                            if ((options.methodchain === "chain" || (options.methodchain === "none" && lines[a] < 1)) && ltype !== "comment" && ltype !== "comment-inline") {
                                ...
                                if (token[begin[a]] !== "(" && token[begin[a]] !== "x(" && (types[a + 2] === "start" || ltoke === ")" || (ei !== undefined && token[ei[ei.length - 1]] !== "."))) {
                                    if (ei !== undefined && token[ei[ei.length - 1]] !== "." && options.nochainindent === false) {
                                        propertybreak();
                                    } else {
                                        level[a - 1] = indent;
                                    }
                                } else if (ei !== undefined && token[ei[ei.length - 1]] === ".") {
                                    level[a - 1] = indent;
                                } else {
                                    level[a - 1] = -20;
                                }
                    ...
                    start         = function jspretty__beautify_start() {
                        ...
                        var ei = extraindent[extraindent.length - 1];
                        if (ctoke === ")" && token[a + 1] === "." && ei !== undefined && ei[ei.length - 1] > -1 && token[ei[0]] !== ":") {
                                        ...
                                        do {
                                            ...
                                            if (begin[aa] === open) {
                                                if (token[aa].indexOf("=") > -1 && types[aa] === "operator" && token[aa].indexOf("!") < 0 && token[aa].indexOf("==") < 0 && token[aa] !== "<=" && token[aa].indexOf(">") < 0) {
                                                    ...
                                                    level[aa] = ind;
                                                } else if (level[aa] > -9 && (token[open - 1] !== "for" || token[aa + 1] === "?" || token[aa + 1] === ":") && (token[begin[a]] !== "(" || token[aa] !== "+")) {
                                                    level[aa] = level[aa] + 1;
                                                }
                                            } else if (level[aa] > -9) {
                                                level[aa] = level[aa] + 1;
