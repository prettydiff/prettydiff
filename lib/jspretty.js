            ...
            (function jspretty__beautify() {
                var a           = 0,
                    ...
                    strwrap     = function jspretty__beautify_strwrap(offset) {
                        ...
                        do {
                            aa -= 1;
                        } while (aa > 0 && (level[aa - 1] === "x" || level[aa - 1] === "s"));
                        ...
                        if (ctoke === "+") {
                            ...
                            return (function jspretty__beautify_operator_plus() {
                                ...
                                if (types[a - 1] === "operator" || types[a - 1] === "start") {
                                    if (types[a + 1] === "word" || token[a + 1] === "(" || token[a + 1] === "[") {
                                        return level.push("x");
                                    }
                                ...
                                do {
                                    ...
                                    if (level[c] !== undefined && level[c] !== "x" && level[c] !== "s") {
                                        break;
                                    }
                                    if (types[c] === "operator" && token[c] !== "+" && begin[c] === begin[a]) {
                                        break;
                                    }
                                    line += token[c].length;
                                    if (level[c] === "s") {
                                ...
                                if (level[c - 1] !== undefined && level[c - 1] !== "x" && level[c - 1] !== "s") {
                                    if (token[c] === "+") {
                                        ind = level[c - 1];
                                    } else if (token[c] === "." || token[c] === "?" || token[c] === ":") {
                                        ind = level[c - 1] + 2;
                                    }
                                } else if (level[c] !== undefined && level[c] !== "x" && level[c] !== "s") {
                                    if (token[c] === "+") {
                                        ind = level[c];
                                    } else if (token[c + 1] === "." || token[c + 1] === "?" || token[c + 1] === ":") {
                                        ind = level[c] + 2;
                                    }
                                }
                                if (line + next < options.wrap) {
                                    ...
                                    if (token[c] === "var" || token[c] === "let" || token[c] === "const") {
                                        line -= (options.insize * options.inchar.length * 2);
                                    }
                                    c = options.wrap - line;
                                    if (c > 0 && c < 5) {
                                        level.push(ind);
                                    ...
                                    } else if (line < options.wrap && (aa.charAt(0) === "\"" || aa.charAt(0) === "'")) {
                                        a += 1;
                                        level.push("s");
                                        if (varline[varline.length - 1] === true && token[c] === "=") {
                                            line += (options.inchar.length * options.insize) - 1;
                                        } else {
                                            line += 3;
                                        }
                                        strwrap(options.wrap - line);
                                    } else {
                                        level.push(ind);
                                    }
                                }
