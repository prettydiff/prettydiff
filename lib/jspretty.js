        ...
        var a              = 0,
            ...
            depthPush      = function jspretty__tokenize_depthPush() {
                ...
                if ((token[last] === "{" || token[last] === "x{") && ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch")) {
                    ...
                    if (classy[classy.length - 1] === 0 && wordx !== "return") {
                    ...
                    } else if (token[last - 2] === "import" || token[last - 3] === "import") {
                        ...
                        //if preceeded by a paren the prior containment is preceeded by a keyword
                        //if (...) {
                        depth.push([pword[0], last]);
                    } else if (depth[last - 1] !== undefined && depth[last - 1][0] === "notation") {
                        //if following a TSX array type declaration
                        depth.push(["function", last]);
                    } else if ((types[last - 1] === "literal" || types[last - 1] === "word") && types[last - 2] === "word" && depth[last - 1] !== undefined && token[depth[last - 1][1] - 1] !== "for") {
                        //if preceed by a word and either string or word
                        //public class {
                        depth.push(["function", last]);
                    } else if (depthlist.length > 0 && depthlist[depthlist.length - 1][0] === "object" && depth[last - 1] !== undefined && (token[depth[last - 1][1] - 2] === "{" || token[depth[last - 1][1] - 2] === ",")) {
                        //if an object wrapped in some containment which is itself preceeded by a curly brace or comma
                        //var a={({b:{cat:"meow"}})};
                        depth.push(["function", last]);
                    } else if (wordx === ":" && (token[last - 3] === "var" || token[last - 3] === "let" || token[last - 3] === "const")) {
                        ...
                        depth.push(["function", last]);
                    } else if (wordx === ")" && depth[last - 1] !== undefined && depth[last - 1][0] === "method" && types[depth[last - 1][1] - 1] === "word") {
                        //what looks like a method is probably a TSX convenience function if followed by a curly brace
                        (function jspretty__tokenize_depthPush_methodFix() {
                            var aa = 0,
                                bb = 0;
                            depth[last - 1][0] = "expression";
                            for (aa = last - 2; aa > -1; aa -= 1) {
                                if (types[aa] === "end") {
                                    bb += 1;
                                ...
                                if (bb === 0) {
                                    if (depth[aa][0] === "method") {
                                        depth[aa][0] = "expression";
                                    }
                                    if (token[aa] === "(" || depth[aa][0] !== "method") {
                                        return;
                                    }
                                }
                            }
                    ...
                    if (token[last - 1] === "}" && depth[last - 1] !== undefined && depth[last - 1] === "function") {
                    ...
                    if (token[lengtha - 3] === "x}") {
                        if (token[lengtha - 2] === "else") {
                            if (token[lengtha - 4] === "x}" && pdepth[0] !== "if" && depth[depth.length - 2][0] === "else") {
                                elsefix(3);
                            } else if (token[lengtha - 4] === "}" && pdepth[0] === "if" && token[pdepth[1] - 1] === "if") {
                                elsefix(3);
                            }
            ...
            asi            = function jspretty__tokenize_asi(isEnd) {
                var len   = token.length - 1,
                    ...
                    paren = false,
                    opers = false,
                    funce = (isEnd === true && deepl[0] === "function" && (types[deepl[1] - 1] === "operator" || types[deepl[1] - 1] === "start")),
                    clist = (depthlist.length === 0)
                        ? ""
                        : depthlist[depthlist.length - 1][0];
                if (types[len] === "comment" || types[len] === "comment-inline" || clist === "method" || clist === "paren" || clist === "expression" || clist === "array" || clist === "object" || (clist === "switch" && token[depth[lengtha - 1][1]] === "(") || (lengtha > 0 && depth[lengtha - 1] !== undefined && depth[lengtha - 1][0] === "expression")) {
                    return;
                }
                ...
                if (deepl[0] === "function" && types[deepl[1] - 1] === "word" && tokel === "}" && types[deepl[1] - 2] !== "start" && types[deepl[1] - 2] !== "operator") {
                    if (token[deepl[1] - 2] === "function" && (types[deepl[1] - 3] === "start" || types[deepl[1] - 3] === "operator")) {
                        funce = true;
                    } else {
                        return;
                    }
                ...
                if (funce === false && ((typel === "literal" && types[len - 1] !== "start") || typel !== "literal")) {
                    for (aa; aa > -1; aa -= 1) {
                        ...
                        if (bb === 0) {
                            ...
                            if (token[aa] === "class" && depth[lengtha - 1][0] === "class" && types[aa - 1] !== "operator") {
                                return;
                            }
                            if (token[aa] === "do") {
                                break;
                ...
                /*if (isEnd === true) {
                    ...
                    depth.splice(len + 1, 0, depthlist[depthlist.length - 1]);
                } else {
                    depth.splice(len + 1, 0, ["global", 0]);
                }*/
                depthPush();
            ...
            generic        = function jspretty__tokenize_genericBuilder(start, ending) {
                ...
                for (ee = base; ee < jj; ee += 1) {
                    ...
                    if (c[ee] === end[endlen - 1] && (c[ee - 1] !== "\\" || slashes(ee - 1) === false)) {
                        if (endlen === 1) {
                            break;
                        }
                        //`ee - base` is a cheap means of computing length of build array
                        //the `ee - base` and `endlen` are both length based values, so adding two (1 for each)
                        //provides an index based number
                        if (build[ee - base] === end[0] && build.slice(ee - base - endlen + 2).join("") === ending) {
                            break;
                        }
                    }
                }
            ...
            markup         = function jspretty__tokenize_markup() {
                ...
                for (d = token.length - 1; d > -1; d -= 1) {
                    if (token[d] === "return" || types[d] === "operator" || token[d - 2] + token[d - 1] + token[d] === "React.render") {
                        if (token[d - 1] === "(") {
                            ltype = "operator";
                            return operator();
                        }
                ...
                destructfix = function jspretty__algorithm_destructFix(listFix, override) {
                    var c = 0,
                        d = (listFix === true)
                            ? 0
                            : 1,
                        arrayCheck = (override !== true && depth[a][0] === "array" && listFix === true && ctoke !== "[");
                ...
                start       = function jspretty__algorithm_start() {
                    ...
                    if (ctoke === "{" || ctoke === "x{") {
                        ...
                        if (ltype === "markup") {
                            ...
                            level[a - 1] = indent - 1;
                        } else if (ltoke === ")" || ltoke === "," || ltype === "markup") {
                            level[a - 1] = "s";
                ...
                operator    = function jspretty__algorithm_operator() {
                    ...
                    if (ctoke === ":") {
                        ...
                        return (function jspretty__algorithm_operator_colon() {
                            ...
                            if (depth[a][0] === "method" && ternary.length === 0) {
                                level[a - 1] = "x";
                            }
                            if (listin === 0) {
                                return level.push("s");
                            ...
                            } else if (depth[a][0] === "function" && ternary.length === 0) {
                                varlen[varlen.length - 1].push(a - 1);
                            }
                            for (c = a - 1; c > -1; c -= 1) {
                                if (types[c] === "start") {
                                ...
                                if (d > 0) {
                                    if (d === 1 && depth[a][0] !== "function" && token[c] === "{" && ternary.length === 0) {
                                        if (types[c + 1] !== "comment" && (types[c + 2] !== "word" || types[c + 1] !== "word")) {
                                            level[c + 1] = "x";
                                            if (varlen[varlen.length - 1][varlen[varlen.length - 1].length - 1] !== c + 1 && types[c + 1] !== "start") {
                            ...
                            if (depth[a][0] !== "object" && ternary.length === 0) {
                                level[a - 1] = "x";
                            }
                            return level.push("s");
                        }());
                    ...
                    if (ltype !== "comment" && ltype !== "comment-inline" && (ctoke !== "?" || ternary.length === 0)) {
                        level[a - 1] = "s";
                    }
