    ...
    if (options.mode === "parse") {
        return (function jspretty__parse() {
            ...
            if (options.correct === false) {
                for (a = 0; a < c; a += 1) {
                    if (token[a] === "x;" || token[a] === "x{" || token[a] === "x}") {
                        c -= 1;
                        begin.splice(a, 1);
                        depth.splice(a, 1);
                        lines.splice(a, 1);
            ...
            if (options.parseFormat === "htmltable") {
                return (function jspretty__parse_html() {
                    var output = [],
                        aa     = 0,
                        len    = 0;
                    output.push("<table summary='CSS parse table'><thead><tr><th>index</th>");
                    output.push("<th>token</th>");
                    output.push("<th>types</th>");
                    output.push("<th>depth</th>");
                    output.push("<th>begin</th>");
                    output.push("<th>lines</th>");
            ...
            var a           = 0,
                ...
                separator   = function jspretty__algorithm_separator() {
                    ...
                    if (ctoke === ",") {
                        ...
                        if (jsxmethod[jsxmethod.length - 1] === false && global.jsxstatus === true && depth[a] === "method" && begin[begin[a] - 1] === 0) {
