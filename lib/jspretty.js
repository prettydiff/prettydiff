            ...
            var a              = 0,
                ...
                markup         = function jspretty__tokenize_markup() {
                    ...
                    if (options.typescript === false && (token[d] === "return" || types[d] === "operator" || types[d] === "start" || types[d] === "separator")) {
                        ltype       = "markup";
                        options.jsx = true;
                    } else if (options.typescript === true || (((/\s/).test(c[a - 1]) === false || ltoke === "public" || ltoke === "private" || ltoke === "static" || ltoke === "final" || ltoke === "implements" || ltoke === "class" || ltoke === "void") && syntaxnum.indexOf(c[a + 1]) < 0)) {
            ...
            (function jspretty__beautify() {
                ...
                for (a = 0; a < b; a += 1) {
                    ...
                    if (ctype === "comment") {
                        ...
                        if (ltoke !== "return" && ltype !== "operator" && ltoke !== "public" && ltoke !== "private" && ltoke !== "static" && ltoke !== "final" && ltoke !== "implements" && ltoke !== "class" && ltoke !== "void") {
                            level[a - 1] = "x";
                        }
                        if (token[a + 1] === "(") {
                            level.push("x");
