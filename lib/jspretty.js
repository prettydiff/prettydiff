    ...
    (function jspretty__tokenize() {
        var a              = 0,
            ...
            asi            = function jspretty__tokenize_asi(isEnd) {
                ...
                if (cdeep === "method" || cdeep === "paren" || cdeep === "expression" || cdeep === "array" || cdeep === "object" || depth[lengtha - 1][0] === "expression") {
                    return;
                }
            ...
            var a           = 0,
                ...
                separator   = function jspretty__algorithm_separator() {
                    ...
                    if (ctoke === ".") {
                        if (options.methodchain === true && ltype !== "comment" && ltype !== "comment-inline") {
                            ...
                            if (starttype[starttype.length - 1] !== "paren" && starttype[starttype.length - 1] !== "method" && (ltoke === ")" || methodbreak[methodbreak.length - 1] === true || (types[a + 1] === "word" && depth[a + 2] !== undefined && depth[a + 2][0] === "method"))) {
                    ...
                    if (ctoke === ",") {console.log(depth[a][0]);
                        level[a - 1] = "x";
                ...
                start       = function jspretty__algorithm_start() {
                    ...
                    if (ctoke === "(") {
                        ...
                        if (ltype === "end" && depth[a - 1][0] !== "if" && depth[a - 1][0] !== "for" && depth[a - 1][0] !== "catch" && depth[a - 1][0] !== "else" && depth[a - 1][0] !== "do" && depth[a - 1][0] !== "try" && depth[a - 1][0] !== "finally" && depth[a - 1][0] !== "catch") {
                            if (types[a - 1] !== "comment" && types[a - 1] !== "comment-inline") {
                                level[a - 1] = "x";
                            } else {
                                level[a - 1] = indent;
