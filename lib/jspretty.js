                            ...
                            var aa          = 0,
                                ...
                                joins       = function jspretty__resultScope_varSpaces_joins(x, vars) {
                                    ...
                                    period = function jspretty__resultScope_varSpaces_joins_period() {
                                        ...
                                        if (types[x] === "word" && types[x - 1] === "word" && token[x - 1] !== "var" && token[x - 1] !== "let" && token[x - 1] !== "const") {
                                            words();
                                        }
                                    };
                                    ...
                                    if (types[x] === "word" && (token[x - 1] === "]" || token[x - 1] === ")")) {
                                        ...
                                        xlen += 1;
                                        ending();
                                    } else if (types[x] === "word" && types[x - 1] === "word" && token[x - 1] !== "var" && token[x - 1] !== "let" && token[x - 1] !== "const") {
                                        words();
