        ...
        var a              = 0,
            ...
            depthPush      = function jspretty__tokenize_depthPush() {
                ...
                if ((token[last] === "{" || token[last] === "x{") && ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch")) {
                    ...
                    } else if ((types[last - 1] === "word" && wordx !== "return") || (wordx === "}" && (depth[last - 1][0] === "function" || depth[last - 1][0] === "class"))) {
                        depth.push(["method", last]);
                    } else {
            ...
            generic        = function jspretty__tokenize_genericBuilder(start, ending) {
                ...
                for (ee = base; ee < jj; ee += 1) {
                    ...
                    if (c[ee] === end[endlen - 1] && (c[ee - 1] !== "\\" || slashes(ee - 1) === false)) {
                        ...
                        //base` and `endlen` are both length based values, so adding two (1 for
                        //each)
        ...
        (function jspretty__algorithm() {
            var a           = 0,
                ...
                separator   = function jspretty__algorithm_separator() {
                    ...
                    if (ternary.length > 0 && ctoke !== "." && options.ternaryline === false) {
                        tern();
                    }
                        ...
                        if (ternary.length > 0) {
                            (function jspretty__algorithm_operator_ternObj() {
                                ...
                                for (c = a - 1; c > 0; c -= 1) {
                                    ...
                                    if (d < 0) {
                                        if (depth[a][0] === "object" && options.ternaryline === false) {
                                            level[a - 1] = "x";
                                    ...
                                    if (d === 0) {
                                        if (token[c] === "," && depth[a][0] === "object" && options.ternaryline === false) {
                                            level[a - 1] = "x";
                                            varlen[varlen.length - 1].push(a - 1);
                                            return;
                                        }
