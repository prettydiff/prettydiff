...
/*
 ...
 -----------------------------------------------------------------------
 */
global.prettydiff.jspretty = function jspretty_(options) {
    "use strict";
    var sourcemap    = [
            0, ""
        ],
    ...
    (function jspretty__options() {
        var styleguide = {},
            brace_style = {};
        styleguide.airbnb = function jspretty__options_airbnb() {
        ...
        styleguide.crockford = function jspretty__options_crockford() {
        ...
        styleguide.google = function jspretty__options_google() {
            options.correct      = true;
            options.inchar       = " ";
            options.insize       = 4;
            options.preserve     = 1;
        ...
        styleguide.grunt = function jspretty__options_grunt() {
            options.inchar       = " ";
            options.insize       = 2;
            options.quoteConvert = "single";
            options.varword      = "each";
        };
        styleguide.jquery = function jspretty__options_jquery() {
            options.bracepadding = true;
            options.correct      = true;
            options.inchar       = "\u0009";
            options.insize       = 1;
        ...
        styleguide.mrdoobs = function jspretty__options_mrdoobs() {
        ...
        styleguide.mediawiki = function jspretty__options_mediawiki() {
            options.bracepadding = true;
            options.correct      = true;
            options.inchar       = "\u0009";
            options.insize       = 1;
        ...
        styleguide.meteor = function jspretty__options_meteor() {
            options.correct = true;
            options.inchar  = " ";
            options.insize  = 2;
            options.wrap    = 80;
        };
        styleguide.yandex = function jspretty__options_yandex() {
            options.bracepadding = false;
            options.correct      = true;
            options.quoteConvert = "single";
            options.varword      = "each";
        ...
        options.brace_style  = (options.brace_style === "collapse" || options.brace_style === "collapse-preserve-inline" || options.brace_style === "expand")
            ? options.brace_style
            : "none"
        ...
        options.braces       = (options.braces === true || options.braces === "true" || options.braces === "allman");
        ...
        options.endcomma     = (options.endcomma === true || options.endcomma === "true" || options.endcomma === "always")
            ? "always"
            : (options.endcomma === "multiline")
                ? "multiline"
                : "never";
        options.formatArray  = (options.formatArray === "indent" || options.formatArray === "inline")
            ? options.formatArray
            : "default";
        options.formatObject = (options.formatObject === "indent" || options.formatObject === "inline")
            ? options.formatObject
            : "default";
        options.functionname = (options.functionname === true || options.functionname === "true");
        ...
        options.mode          = (options.mode === "minify" || options.mode === "parse" || options.mode === "diff" || options.mode === "analysis")
            ? options.mode
            : "beautify";
        ...
        options.qml           = (options.qml === true || options.qml === "true");
    ...
    (function jspretty__tokenize() {
        var a              = 0,
            ...
            commentwrap    = function jspretty__tokenize_commentwrap(comment, line) {
                ...
                lengtha = token.length;
                if ((/\s/).test(comment.charAt(2)) === false) {
                    if (line === true) {
    ...
    if (options.mode === "beautify" || options.mode === "diff") {
        ...
        (function jspretty__algorithm() {
            var a           = 0,
                ...
                template    = function jspretty__algorithm_template() {
                ...
                markup      = function jspretty__algorithm_markup() {
                ...
                separator   = function jspretty__algorithm_separator() {
                    ...
                    if (ctoke === ",") {
                        ...
                        if (jsxmethod[jsxmethod.length - 1] === false && options.jsx === true && depth[a] === "method") {
                            (function jspretty__algorithm_separator_jsxmethod() {
                                var aa = begin[a] + 1,
                                    bb = 0,
                                    cc = false;
                                do {
                ...
                start       = function jspretty__algorithm_start() {
                    ...
                    itemcount.pop();
                    if (ctoke === "}") {
                        if (varline[varline.length - 1] === true || ((depth[a] === "object" || depth[a] === "function") && ltoke !== "{") || token[begin[a] - 2] === "interface") {
...
if (typeof module === "object" && typeof module.parent === "object") {
    ...
    module.exports = global.prettydiff.jspretty;
