        ...
        (function jspretty__tokenize() {
            var a              = 0,
                ...
                asi            = function jspretty__tokenize_asi(isEnd) {
                    ...
                    if (tokel === ";" || tokel === "," || next === "{" || (deepl === "array" && tokel !== "]") || (typel !== undefined && typel.indexOf("template") > -1) || (next === ";" && isEnd === false)) {
                        return;
                    }
                    if (options.qml === true) {
                        if (typel === "start") {
            ...
            (function jspretty__beautify() {
                var a           = 0,
                    ...
                    operator    = function jspretty__beautify_operator() {
                        ...
                        if (ctoke === ":") {
                            if ((ltype === "word" || ltoke === ")" || ltoke === "]" || ltoke === "?") && (depth[a] === "map" || types[a + 1] === "word") && (ternary.length === 0 || ternary[ternary.length - 1] < begin[a]) && ("mapclassexpressionmethodglobalparen".indexOf(depth[a]) > -1 || (types[a - 2] === "word" && depth[a] !== "switch"))) {
                                level[a - 1] = "x";
        ...
        if (options.mode === "minify") {
            ...
            if (options.jsscope !== "none") {
                        ...
                        (function jspretty__resultScope_varSpaces() {
                            var aa          = 0,
                                ...
                                joins       = function jspretty__resultScope_varSpaces_joins(x, vars) {
                                    ...
                                    } else if (token[x] === "?" && types[x - 1] === "word") {
                ...
                result = (function jspretty__result() {
                    ...
                    if (verticalop === true) {
                        (function jspretty__result_varSpaces() {console.log(varlist);
                            var aa          = 0,
                                varListLen  = 0,
                                cc          = 0,
                                dd          = 0,
