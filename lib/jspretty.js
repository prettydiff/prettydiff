...
var jspretty = function jspretty_(options) {
    ...
    var sourcemap    = [
        ...
        // meta used to find scope and variables for jsscope these values are assigned in
        // parallel to the other arrays
        ...
        var a              = 0,
            ...
            generic        = function jspretty__tokenize_genericBuilder(start, ending) {
                ...
                for (ee = base; ee < jj; ee += 1) {
                    if (c[ee] === "<" && c[ee + 1] === "?" && c[ee + 2] === "p" && c[ee + 3] === "h" && c[ee + 4] === "p") {
                        a = ee;
                        build.push(jspretty__tokenize_genericBuilder("<\?php", "?>"));
                        ee += build[build.length - 1].length;
                    } else if (c[ee] === "<" && c[ee + 1] === "%") {
                        a = ee;
