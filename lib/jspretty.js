        ...
        (function jspretty__tokenize() {
            var a              = 0,
                ...
                depthPush      = function jspretty__tokenize_depthPush() {
                    ...
                    if ((token[last] === "{" || token[last] === "x{") && ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch")) {
                        ...
                        if (classy[classy.length - 1] === 0 && wordx !== "return") {
                            ...
                            depth.push("array");
                        } else if (types[aa] === "word" && (types[aa - 1] === "word" || (token[aa - 1] === "?" && types[aa - 2] === "word")) && token[aa] !== "in" && token[aa - 1] !== "export" && token[aa - 1] !== "import" && token[aa - 2] !== "export" && token[aa - 2] !== "import") {
                            depth.push("map");
                ...
                asi            = function jspretty__tokenize_asi(isEnd) {
                    ...
                    if (tokel === ";" || tokel === "," || next === "{" || deepl === "class" || deepl === "map" || deepl === "attribute" || clist === "initializer" || types[begnl - 1] === "generic" || (deepl === "array" && tokel !== "]") || (typel !== undefined && typel.indexOf("template") > -1) || (next === ";" && isEnd === false)) {
                        return;
                    }
                    if (options.qml === true) {
                        if (typel === "start") {
                ...
                markup         = function jspretty__tokenize_markup() {
                    ...
                    if (options.typescript === false && (token[d] === "return" || types[d] === "operator" || types[d] === "start" || types[d] === "separator")) {
                        ltype       = "markup";
                        options.jsx = true;
                    } else if (options.typescript === true || ((/\s/).test(c[a - 1]) === false && syntaxnum.indexOf(c[a + 1]) < 0)) {
                        return (function jspretty__tokenize_markup_generic() {
                            ...
                            for (d = a + 2; d < b; d += 1) {
                                ...
                                if ((syntax.indexOf(c[d]) > -1 && c[d] !== "," && c[d] !== "<" && c[d] !== ">") || (comma === false && (/\s/).test(c[d]) === true)) {
                                    ltype = "operator";
                                    return operator();
                                }
                            }
        ...
        if (options.mode === "beautify" || options.mode === "diff") {
            ...
            (function jspretty__beautify() {
                var a           = 0,
                    ...
                    listend     = function jspretty__beautify_listend() {
                        var aa    = 0,
                            bb    = 0,
                            nt    = token[a + 1],
                            endit = function jspretty__beautify_listend_endit() {
                    ...
                    separator   = function jspretty__beautify_separator() {
                        ...
                        if (ctoke === ";" || ctoke === "x;") {
                            tern(-1);
                            if (depth[a] !== "class" && depth[a] !== "map" && depth[a] !== "function" && depth[a] !== "try" && depth[a] !== "catch" && depth[a] !== "while") {
                                listend();
                            } else {
                                destructfix();
                            }
                    ...
                    start       = function jspretty__beautify_start() {
                        ...
                        if (options.neverflatten === true || options.qml === true || deep === "attribute" || (deep === "class" && ltoke !== "(") || (ctoke === "[" && token[a + 1] === "function")) {
                            ...
                            if ((deep === "object" || deep === "class") && (ltoke === "(" || ltype === "word")) {
                        ...
                        if (ctoke === "(") {
                            ...
                            if (deep === "method" || (token[a - 2] === "function" && ltype === "word")) {
                                if (ltoke === "import" || options.functionname === true) {
                                    level[a - 1] = "s";
                                } else {
                                    level[a - 1] = "x";
                                }
                        ...
                        if (options.qml === true) {
                            ...
                            level.push("s");
                        } else if ((ctoke === "}" || ctoke === "x}") && depth[a] !== "object" && ltype === "word" && list[list.length - 1] === false) {
                            indent       += 1;
                            level[a - 1] = indent;
                            level.push(indent);
                        ...
                        itemcount.pop();
                        if (ctoke === "}") {
                            if (varline[varline.length - 1] === true || ((depth[a] === "object" || depth[a] === "function" || depth[a] === "map") && ltoke !== "{") || token[begin[a] - 2] === "interface") {
                ...
                for (a = 0; a < b; a += 1) {
                    ...
                    if (ctype === "comment") {
                        ...
                        if (ltoke !== "return" && ltype !== "operator") {
                            level[a - 1] = "x";
                        }
                        if (token[a + 1] === "(") {
                            level.push("x");
                                ...
                                joins       = function jspretty__resultScope_varSpaces_joins(x, vars) {
                                    ...
                                    ending = function jspretty__resultScope_varSpaces_joins_ending() {
                                        ...
                                        if (token[x - 1] === ")" || token[x - 1] === "]") {
                                            ...
                                            jspretty__resultScope_varSpaces_joins_ending();
                                        }
                                    };
                                ...
                                joins       = function jspretty__result_varSpaces_joins(x, vars) {
                                    ...
                                    ending = function jspretty__result_varSpaces_joins_ending() {
                                        ...
                                        if (token[x - 1] === ")" || token[x - 1] === "]") {
                                            ...
                                            jspretty__result_varSpaces_joins_ending();
                                        }
                                    };
