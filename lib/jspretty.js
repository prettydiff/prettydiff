    ...
    var sourcemap    = [
        ...
        extlib       = function jspretty__extlib(ops) {
            var item = (ops === undefined)
                ? global.markuppretty(ops)
                : global.markuppretty(options);
    ...
    if (options.mode === "parse") {
        return (function jspretty__parse() {
            ...
            for (a = 0; a < c; a += 1) {
                ...
                if (options.parseFormat !== "htmltable" && types[a] === "markup" && global.markuppretty !== undefined) {
                    options.source = token[a];
                    options.jsx    = true;
                    token[a]       = global.markuppretty(options).data;
                }
            }
            ...
            if (options.parseFormat === "htmltable") {
                return (function jspretty__parse_html() {
                    ...
                    for (aa = 0; aa < len; aa += 1) {
                        if (types[aa] === "markup" && global.markuppretty !== undefined) {
                            options.source = token[aa];
                            options.jsx    = true;
                            output.push("<tr><td colspan=\"6\" class=\"nested\">");
                            output.push(global.markuppretty(options).data.replace("<thead>", "<thead><tr><th colspan=\"10\" class=\"nested\">markup tokens</th></tr>"));
                            output.push("</td></tr>");
            ...
            var a           = 0,
                ...
                separator   = function jspretty__algorithm_separator() {
                    ...
                    if (ctoke === ",") {
                        ...
                        if (jsxmethod[jsxmethod.length - 1] === false && global.jsxstatus === true && depth[a] === "method") {
