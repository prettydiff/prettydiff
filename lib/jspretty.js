        ...
        (function jspretty__tokenize() {
            var a              = 0,
                ...
                markup         = function jspretty__tokenize_markup() {
                    ...
                    if (((token[lengtha - 2] !== "::" || c[a] !== "<") && syntaxnum.indexOf(c[a + 1]) > -1) || token[d] === "++" || token[d] === "--" || (/\s/).test(c[a + 1]) === true || ((/\d/).test(c[a + 1]) === true && (ltype === "operator" || ltype === "literal" || (ltype === "word" && ltoke !== "return")))) {
                        ltype = "operator";
                        return operator();
                    }
                    if (options.typescript === false && (token[d] === "return" || types[d] === "operator" || types[d] === "start" || types[d] === "separator" || (token[d] === "}" && depthlist[depthlist.length - 1][0] === "global"))) {
                        ltype       = "markup";
                        options.jsx = true;
                    } else if (token[lengtha - 2] === "::" || options.typescript === true || token[lengtha - 1] === "#include" || (((/\s/).test(c[a - 1]) === false || ltoke === "public" || ltoke === "private" || ltoke === "static" || ltoke === "final" || ltoke === "implements" || ltoke === "class" || ltoke === "void" || ltoke === "Promise") && syntaxnum.indexOf(c[a + 1]) < 0)) {
                        //Java type generics
            ...
            (function jspretty__beautify() {
                var a           = 0,
                    ...
                    endExtraInd = function jspretty__beautify_endExtraInd() {
                        ...
                        c = ei.length - 1;
                        if (ei.length < 2 && ei[c] < 0 && (ctoke === ";" || ctoke === "x;" || ctoke === ")" || ctoke === "x)" || ctoke === "}" || ctoke === "x}")) {
                            return ei.pop();
                        }
                        if (c < 0 || ei[c] < 0) {
                            return;
                            ...
                            if (jsxmethod[jsxmethod.length - 1] === false && options.jsx === true && depth[a] === "method") {
                                (function jspretty__beautify_separator_jsxmethod() {
                                    ...
                                    do {
                                        bb += token[aa].length;
                                        aa += 1;
                                        cc = ((token[aa] === ")" || token[aa] === "x)") && begin[aa] === begin[a]);
                    ...
                    start       = function jspretty__beautify_start() {
                        ...
                        if (options.bracepadding === true && ltype !== "start" && ltoke !== ";" && (level[begin[a]] === "x" || level[begin[a]] === "s" || destruct[destruct.length - 1] ===  true)) {
                            ...
                            level[a - 1] = indent;
                            level.push("x");
                        } else if ((ctoke === ")" || ctoke === "x)") && jsxmethod[jsxmethod.length - 1] === true) {
                            level[a - 1] = indent;
                            level.push("x");
                            ...
                            level.push("x");
                        } else if ((ctoke === ")" || ctoke === "x)") && ltype !== "markup") {
                            level[a - 1] = "x";
                            level.push("s");
