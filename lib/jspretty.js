        ...
        (function jspretty__tokenize() {
            var a              = 0,
                ...
                depthPush      = function jspretty__tokenize_depthPush() {
                    ...
                    if ((token[last] === "{" || token[last] === "x{") && ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch")) {
                        ...
                        if (classy[classy.length - 1] === 0 && wordx !== "return") {
                            ...
                            depth.push("array");
                        } else if (types[last - 1] === "word" && types[last - 2] === "word" && token[aa] !== "in" && token[aa - 1] !== "export" && token[aa - 1] !== "import" && token[aa - 2] !== "export" && token[aa - 2] !== "import") {
                            depth.push("map");
                ...
                asi            = function jspretty__tokenize_asi(isEnd) {
                    ...
                    if (tokel === ";" || tokel === "," || next === "{" || deepl === "class" || types[begnl - 1] === "generic" || (deepl === "array" && tokel !== "]") || (typel !== undefined && typel.indexOf("template") > -1) || (next === ";" && isEnd === false)) {
                        return;
                    }
                    if (options.qml === true) {
                        if (typel === "start") {
                ...
                //operations for end types: ), ], }
                    ...
                    if (ltoke === "," && ((x === "]" && (options.endcomma === "never" || options.endcomma === "multiline" || token[lengtha - 2] === "[")) || x === "}")) {
                        tokenpop();
                ...
                var a           = 0,
                    ...
                    separator   = function jspretty__beautify_separator() {
                        ...
                        if (ctoke === ",") {
                            ...
                            if (wordlist[wordlist.length - 1] === true) {
                                return level.push("s");
                            }
                    ...
                    start       = function jspretty__beautify_start() {
                        ...
                        itemcount.push(0);
                        varlen.push([]);
                        if (options.neverflatten === true || options.qml === true || (ctoke === "[" && token[a + 1] === "function")) {
                            destruct.push(false);
                        } else {
                    ...
                    operator    = function jspretty__beautify_operator() {
                        ...
                        if (ctoke === ":") {
                            if (depth[a] === "array" && (ternary.length < 1 || ternary[ternary.length - 1] < begin[a])) {
                                level[a - 1] = "x";
                                return level.push("s");
                            }
