        ...
        (function jspretty__tokenize() {
            var a              = 0,
                ...
                asi            = function jspretty__tokenize_asi(isEnd) {
                    ...
                    if (tokel === ";" || tokel === "," || next === "{" || deepl === "class" || (deepl === "array" && tokel !== "]") || (typel !== undefined && typel.indexOf("template") > -1) || (next === ";" && isEnd === false)) {
                        return;
                    }
                    if (options.qml === true) {
                        if (typel === "start") {
                ...
                markup         = function jspretty__tokenize_markup() {
                    ...
                    if (token[d] === "return" || types[d] === "operator" || types[d] === "start" || types[d] === "separator") {
                        ltype       = "markup";
                        options.jsx = true;
                    } else if ((/\s/).test(c[a - 1]) === false && syntaxnum.indexOf(c[a + 1]) < 0) {
                        return (function jspretty__tokenize_markup_generic() {
                            ...
                            for (d = a + 2; d < b; d += 1) {
                                ...
                                if (syntax.indexOf(c[d]) > -1 || (/\s/).test(c[d]) === true) {
                                    ltype = "operator";
                                    return operator();
                                }
                            }
                    ...
                    operator    = function jspretty__beautify_operator() {
                        ...
                        if (ctoke === "+") {
                            if (ltoke.length < options.wrap + 3 && (ltoke.charAt(0) === "\"" || ltoke.charAt(0) === "'") && (token[a + 1].charAt(0) === "\"" || token[a + 1].charAt(0) === "'")) {
                                ...
                                if (list[list.length - 1] === true || depth[a] === "object" || depth[a] === "method" || ((token[a - 1].charAt(0) === "\"" || token[a - 1].charAt(0) === "'") && (token[a - 2] === "+" || token[a - 2].indexOf("=") > -1 || types[a - 2] === "start"))) {
                            ...
                            var aa          = 0,
                                ...
                                joins       = function jspretty__resultScope_varSpaces_joins(x, vars) {
                                    ...
                                    words  = function jspretty__resultScope_varSpaces_joins_words() {
                                        ...
                                        if (token[x] === "return" && perTest === false) {
                                            xlen += 1;
                                        }
                                        if (token[x - 1] === "]" || token[x - 1] === ")") {
                                            ending();
