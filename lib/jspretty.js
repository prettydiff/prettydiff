        ...
        var a              = 0,
            ...
            depthPush      = function jspretty__tokenize_depthPush() {
                ...
                if ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch") {
                    ...
                    if (types[last] === "method") {
                        depth.push(["method", last]);
                    } else if (wordx === "if" || wordx === "for" || wordx === "function" || wordx === "class" || wordx === "while" || wordx === "catch") {
                    ...
                    if (dd < 0 && cc < startlen) {
                        ...
                        if (token[cc - 1] === "=" || token[cc - 1] === ":" || token[cc - 1] === "(" || token[cc - 1] === "[" || token[cc - 1] === "," || types[cc - 1] === "word" || cc === 0) {
                            if (keys.length > 1) {
                                ...
                                if (options.endcomma === true && types[lengtha - 1] !== "start" && types[lengtha - 1] !== "method") {
                                    tokenpush(true, 0);
                                }
                            } else if (options.endcomma === true && types[lengtha - 1] !== "start" && types[lengtha - 1] !== "method") {
                                tokenpush(true, 0);
                            }
                        }
                        return;
            ...
            asi            = function jspretty__tokenize_asi(isEnd) {
                ...
                if (funce === false && ((typel === "literal" && types[len - 1] !== "start") || typel !== "literal")) {
                    for (aa = aa; aa > -1; aa -= 1) {
                        ...
                        if (bb === 0) {
                            if (token[aa] === "," && options.endcomma === true && token[lengtha - 1] !== "," && types[lengtha - 1] !== "start" && types[lengtha - 1] !== "method") {
                                return tokenpush(true, 0);
                            }
            ...
            start          = function jspretty__tokenize_start(x) {
                ...
                if (x === "(") {
                    if (ltoke === ")" || token[token.length - 1] === "x;") {
                        ...
                        ltype = "start";
                    } else if ((token[lengtha - 1] === "function" && options.space === false) || token[token.length - 2] === "function") {
                        ltype = "method";
            ...
            var a           = 0,
                ...
                start       = function jspretty__algorithm_start() {
                    ...
                    if (ctoke === "]" && (methodbreak[methodbreak.length - 1] === true || arrbreak[arrbreak.length - 1] === true)) {
                        ...
                        if (options.bracepadding === true && ltype !== "end" && ltype !== "start" && ltype !== "method") {
                            level[a - 1] = "s";
                        } else {
                            level[a - 1] = "x";
                        }
