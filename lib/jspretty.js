                        ...
                        if (ctoke === "+") {
                            ...
                            return (function jspretty__beautify_operator_plus() {
                                ...
                                do {
                                    ...
                                    if (level[c] !== undefined && level[c] > -9) {
                                        break;
                                    }
                                ...
                                if (level[c - 1] !== undefined && level[c - 1] > -9) {
                                    if (token[c] === "+") {
                                        ind = level[c - 1];
                                    } else if (token[c] === "." || token[c] === "?" || token[c] === ":") {
                                        ind = level[c - 1] + 2;
                                    }
                                } else if (level[c] !== undefined && level[c] > -9) {
                                    if (token[c] === "+") {
                                        ind = level[c];
                    ...
                    result = (function jspretty__result_standard() {
                        ...
                        for (a = 0; a < b; a += 1) {
                            ...
                            if (types[a] === "comment" || (token[a] !== "x;" && token[a] !== "x{" && token[a] !== "x}" && token[a] !== "x(" && token[a] !== "x)")) {
                                if (types[a] === "markup") {
                                    if (level[a - 1] > -9 && token[a - 1] !== "return" && depth[a] !== "global" && depth[a] !== "array") {
                                        build.push(tab);
                                    }
                                    if (typeof global.prettydiff.markuppretty === "function") {
                                        markupwrapper();
