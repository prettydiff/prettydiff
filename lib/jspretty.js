        ...
        var a              = 0,
            ...
            logError       = function jspretty__tokenize_logError(message, start) {
                ...
                if (global.meta.error === "" || global.meta.error === undefined) {
                    global.meta.error = message + error[1];
                }
            },
            ...
            start          = function jspretty__tokenize_start(x) {
                ...
                depthlist.push([depth[depth.length - 1], begin[begin.length - 1]]);
            },
        ...
        return (function csspretty__parse() {
            var a      = 0,
                ...
                def    = {
                    ...
                    types: "string - Data types of the tokens: comment, comment-inline, end, literal, markup, operator, regex, separator, start, template, template_else, template_end, template_start, word",
