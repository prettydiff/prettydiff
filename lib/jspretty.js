                ...
                word           = function jspretty__tokenize_word() {
                    ...
                    if (output === "else") {
                        ...
                        if (token[lengtha - 3] === "x}") {
                            if (token[lengtha - 2] === "else") {//console.log(token);console.log(token[begin[lengtha - 3]]);
                    ...
                    var insert   = false,
                        ...
                        newarray = function jspretty__tokenize_end_newarray() {
                            ...
                            if (ar === true && token[cc - 1] === "(" && types[cc] === "literal" && token[cc].charAt(0) !== "\"" && token[cc].charAt(0) !== "'") {
                                ...
                                depthlist[depthlist.length - 1] = ["array", lengtha - 1];
                                do {
                                    tokenpush(true, 0);
                                    arraylen -= 1;
                                } while (arraylen > 0);
                                ...
                                begin.splice(aa - 2, 2);
                                lengtha -= 2;
                                depthlist[depthlist.length - 1] = [namear, aa - 2];
                                pdepth = [namear, aa];
                                bb      = lengtha - 1;
                                do {
                                    if (begin[bb] === cc) {
        ...
        if (options.mode === "beautify" || options.mode === "diff") {
            ...
            (function jspretty__beautify() {
                var a           = 0,
                    ...
                    extraindent = [[]], //stores token indexes where extra indentation occurs from ternaries and broken method chains
                    ...
                    endExtraInd = function jspretty__beautify_endExtraInd() {
                        ...
                        c = ei.length - 1;
                        if (ei.length < 2 && ei[c] < 0 && (ctoke === ";" || ctoke === "x;" || ctoke === ")" || ctoke === "}")) {
                            return ei.pop();
                        }
                        if (c < 0 || ei[c] < 0) {
                            return;
                    ...
                    destructfix = function jspretty__beautify_destructFix(listFix, override) {
                        ...
                        var c          = 0,
                            d          = (listFix === true)
                                ? 0
                                : 1,
                            ei         = extraindent[extraindent.length - 1],
                        ...
                        for (c = a - 1; c > -1; c -= 1) {
                            ...
                            if (d === 0) {
                                if (depth[a] === "class" || depth[a] === "map" || (arrayCheck === false && ((listFix === false && token[c] !== "(") || (listFix === true && token[c] === ",")))) {
                                    ...
                                    } else if (ei !== undefined && ei.length > 0 && ei[ei.length - 1] > -1) {
                                        level[c] = indent - 1;
                                    } else {
                                        level[c] = indent;
                                    }
                    ...
                    separator   = function jspretty__beautify_separator() {
                        ...
                        if (ctoke === ".") {
                            ...
                            if ((options.methodchain === "chain" || (options.methodchain === "none" && lines[a] < 1)) && ltype !== "comment" && ltype !== "comment-inline") {
                                ...
                                if (token[begin[a]] !== "(" && (types[a + 2] === "start" || ltoke === ")" || token[ei[ei.length - 1]] !== ".")) {
                        ...
                        if (ctoke === ",") {
                            ...
                            if (token[begin[a]] === "(" && options.jsx === false && depth[a] !== "global" && (types[a - 1] !== "literal" || token[a - 2] !== "+" || (types[a - 1] === "literal" && token[a - 2] === "+" && types[a - 3] !== "literal"))) {
                                return level.push("s");
                            }
                    ...
                    start       = function jspretty__beautify_start() {
                        ...
                        var ei = extraindent[extraindent.length - 1];
                        superindent = 0;
                        if (ctoke === ")" && token[a + 1] === "." && ei !== undefined && ei[ei.length - 1] > -1) {
                        ...
                        if (options.bracepadding === true && ltype !== "start" && ltoke !== ";" && (level[begin[a]] === "x" || level[begin[a]] === "s" || destruct[destruct.length - 1] ===  true)) {
                            ...
                            level[a - 1] = "x";
                            level.push(indent);
                        } else if (depth[a] === "array" && ((ei !== undefined && ei.length > 0) || arrbreak[arrbreak.length - 1] === true)) {
                            endExtraInd();
                            destruct[destruct.length - 1] = false;
                            level[begin[a]] = indent + 1;
                            level[a - 1] = indent;
                            level.push("x");
                        } else if ((depth[a] === "object" || (begin[a] === 0 && ctoke === "}")) && ei !== undefined && ei.length > 0) {
                            endExtraInd();
                            destruct[destruct.length - 1] = false;
                            level[begin[a]] = indent + 1;
                            level[a - 1] = indent;
                    ...
                    operator    = function jspretty__beautify_operator() {
                        var ei = extraindent[extraindent.length - 1];
                        if (ei !== undefined && ei.length > 0 && ei[ei.length - 1] > -1 && depth[a] === "array") {
                            arrbreak[arrbreak.length - 1] = true;
                        }
                        if (ctoke !== ":") {
                            if (token[begin[a]] !== "(" && destruct.length > 0) {
                                destructfix(true, false);
                            }
                            if (ctoke !== "?" && ei !== undefined && token[ei[ei.length - 1]] === ".") {
                                (function () {
                                    var c = a,
                                        d = begin[c],
                                        e = 0;
                        ...
                        if (ctoke === ":") {
                            ...
                            if ((token[a - 2] === "var" || token[a - 2] === "let" || token[a - 2] === "const" || token[a - 2] === "," || (depth[a] === "global" && options.jsx === true && ternary.length < 1)) && ltype === "word" && token[begin[a]] !== "(") {
                                level[a - 1] = "x";
                                if (depth[a] === "object" || (varline[varline.length - 1] === true && token[begin[a]] !== "(")) {
                            ...
                            if (token[begin[a]] !== "(" && (ltype === "word" || ltoke === ")" || ltoke === "]" || ltoke === "?") && (depth[a] === "map" || depth[a] === "class" || types[a + 1] === "word") && (ternary.length === 0 || ternary[ternary.length - 1] < begin[a]) && ("mapclassexpressionmethodglobalparen".indexOf(depth[a]) > -1 || (types[a - 2] === "word" && depth[a] !== "switch"))) {
                                level[a - 1] = "x";
                                varlen[varlen.length - 1].push(a - 1);
                                return level.push("s");
                            }
                                        ...
                                        (function jspretty__beautify_operator_stringBreak() {
                                            ...
                                            for (c = a; c > 0; c -= 1) {
                                                if (d === 0 && types[c] === "separator") {
                                                    if (token[c] === "." && level[c - 1] !== "s" && level[c - 1] !== "x" && options.nochainindent === false) {
                        ...
                        if (ctoke.indexOf("=") > -1 && ctoke !== "==" && ctoke !== "===" && ctoke !== "!=" && ctoke !== "!==" && ctoke !== ">=" && ctoke !== "<=" && depth[a] !== "method" && depth[a] !== "object") {
                            ...
                            (function jspretty__beautify_operator_assignSpaces() {
                                var c = 0,
                                    ...
                                    e = false,
                                    f = "";
                                if (token[begin[a]] === "(" && token[a + 1] !== "function") {
                                    return;
                                }
                                for (c = a + 1; c < b; c += 1) {
                                    if (types[c] === "start") {
                    ...
                    word        = function jspretty__beautify_word() {
                        ...
                        if (varline[varline.length - 1] === true && (ltoke === "," || ltoke === "var" || ltoke === "let" || ltoke === "const")) {
                            if (token[begin[a] - 1] !== "for" && depth[a] !== "method" && token[begin[a]] !== "(") {
                            ...
                            var aa          = 0,
                                ...
                                joins       = function jspretty__resultScope_varSpaces_joins(x) {
                                    var xlen    = token[x].length,
                                        y       = x;
                                    if (level[x] === "x" || level[x] === "s") {
                                        do {
                                            y -= 1;
                                            if (level[y] !== "x" && level[y] !== "s") {
                                                break;
                                            }
                                            if (level[y] === "s") {
                                                xlen += 1;
                                        ...
                                        xlen += (options.inchar.length * options.insize * level[y]);
                                    } else {
                                        xlen += (options.inchar.length * options.insize * level[x]);
                                    }
                                    return xlen;
                                };
                            ...
                            var aa          = 0,
                                ...
                                joins       = function jspretty__result_varSpaces_joins(x) {
                                    ...
                                    if (level[x] === "x" || level[x] === "s") {
                                        ...
                                        if (level[y] !== "x" && level[y] !== "s" && level[y] > 0) {
                                            xlen += (options.inchar.length * options.insize * level[y]);
                                        }
                                    } else {
                                        xlen += (options.inchar.length * options.insize * level[x]);
                                    ...
                                    if (depth[x] === "global" && varlist[0][0] === x && options.lang !== "javascript") {
                                        ...
                                        do {
                                            y -= 1;
                                        } while (y > -1 && (level[y] === "x" || level[y] === "s"));
                                        if (y < 0) {
                                            xlen += (options.inchar.length * options.insize * options.inlevel);
                                        }
                                    }
                                    return xlen;
                                };
