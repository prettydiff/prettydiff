                            ...
                            if (options.wrap > 0 && ctoke === ")") {
                                (function jspretty__beautify_end_parenWrap() {
                                    ...
                                    if (((comma === true || mark === true) && len >= wrap) || level[open] > -9) {
                                        if (token[ext[0]] !== ":" && extraindent.length > 1 && extraindent[extraindent.length - 2].length === 0 && extraindent[extraindent.length - 1].length > 0) {
                                            ind = level[open];
                                        } else if (exl > 0 && ext[ext.length - 1] > aa) {
                                            ind = ind - exl;
                                        }
                                        destruct[destruct.length - 1] = false;
                                        aa = a;
                        ...
                        if (ctoke === "?") {
                            ...
                            if (options.ternaryline === true) {
                                ...
                                (function jspretty__beautify_operator_ternObj() {
                                    ...
                                    level[a - 1] = indent;
                                    if (token[begin[a]] === "(" && level[begin[a]] < 0) {
                                        destruct[destruct.length - 1] = false;
                                        if (begin[a] === a - 2) {
                                            level[begin[a]] = indent - 1;
                                        } else {
