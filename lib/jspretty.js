...
(function jspretty_init() {
    ...
    var jspretty = function jspretty_(options) {
        var sourcemap    = [
            ...
            extlib       = function jspretty__extlib(ops) {
                var item = (ops === undefined)
                    ? global.prettydiff.markuppretty(ops)
                    : global.prettydiff.markuppretty(options);
        ...
        (function jspretty__options() {
            ...
            options.titanium      = (options.titanium === true || options.titanium === "true")
                ...
                : false;
            styleguide.airbnb = function options_validate_airbnb() {
            ...
            styleguide.crockford = function options_validate_crockford() {
            ...
            styleguide.google = function options_validate_google() {
                options.correct      = true;
                options.inchar       = " ";
                options.insize       = 4;
                options.preserve     = 1;
            ...
            styleguide.grunt = function options_validate_grunt() {
                options.inchar       = " ";
                options.insize       = 2;
                options.quoteConvert = "single";
                options.varword      = "each";
            };
            styleguide.jquery = function options_validate_jquery() {
                options.bracepadding = true;
                options.correct      = true;
                options.inchar       = "\u0009";
                options.insize       = 1;
            ...
            styleguide.mrdoobs = function options_validate_mrdoobs() {
            ...
            styleguide.mediawiki = function options_validate_mediawiki() {
                options.bracepadding = true;
                options.correct      = true;
                options.inchar       = "\u0009";
                options.insize       = 1;
            ...
            styleguide.meteor = function options_validate_meteor() {
                options.correct = true;
                options.inchar  = " ";
                options.insize  = 2;
                options.wrap    = 80;
            };
            styleguide.yandex = function options_validate_yandex() {
                options.bracepadding = false;
                options.correct      = true;
                options.quoteConvert = "single";
                options.varword      = "each";
            ...
            brace_style.collapse = function options_validate_collapse() {
            ...
            brace_style["collapse-preserve-inline"] = function options_validate_collapseInline() {
                options.braceline = false;
                options.bracepadding = true;
                options.braces = false;
            ...
            brace_style.expand = function options_validate_expand() {
                options.braceline = false;
                options.bracepadding = false;
                options.braces = true;
                options.formatObject = "indent";
        ...
        (function jspretty__tokenize() {
            var a              = 0,
                ...
                depthPush      = function jspretty__tokenize_depthPush() {
                    ...
                    if ((token[last] === "{" || token[last] === "x{") && ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch")) {
                        ...
                        if (lengtha === 1 && options.jsx === true) {
                        ...
                        } else if (token[last] === "{" && wordx === ")" && (types[begin[aa] - 1] === "word" || token[begin[aa] - 1] === "]")) {
                            if (wordy === "if") {
                                depth.push("if");
                            } else if (wordy === "for") {
                                depth.push("for");
                            ...
                            depth.push("function");
                        } else if (depthlist.length > 0 && token[aa] !== ":" && depthlist[depthlist.length - 1][0] === "object" && (token[begin[aa] - 2] === "{" || token[begin[aa] - 2] === ",")) {
                ...
                word           = function jspretty__tokenize_word() {
                    ...
                    if (options.correct === true && (output === "Object" || output === "Array") && c[a + 1] === "(" && c[a + 2] === ")" && token[lengtha - 2] === "=" && token[lengtha - 1] === "new") {
                        ...
                        if (output === "else" && (types[g] === "comment" || types[g] === "comment-inline")) {
                            ...
                            do {
                                build = [token[g], types[g], lines[g], depth[g], begin[g]];
                                tokenpop();
                        ...
                        if (token[lengtha - 3] === "x}") {
                            if (token[lengtha - 2] === "else") {
                                if (token[lengtha - 4] === "x}" && pdepth[0] !== "if" && depth[depth.length - 2] === "else") {
                                    elsefix(3);
                                } else if (token[lengtha - 4] === "}" && depth[lengtha - 4] === "if" && pdepth[0] === "if" && token[pdepth[1] - 1] === "if") {
                                    elsefix(3);
                                }
                ...
                asi            = function jspretty__tokenize_asi(isEnd) {
                    ...
                    if (tokel === ";" || tokel === "," || next === "{" || deepl === "class" || deepl === "map" || deepl === "attribute" || clist === "initializer" || types[begnl - 1] === "generic") {
                        return;
                    }
                ...
                commentwrap    = function jspretty__tokenize_commentwrap(comment, line) {
                    var prior        = "",
                        ...
                        commentSplit = function jspretty__tokenize_commentLine_commentSplit() {
                            ...
                            if (line === true) {
                                ...
                                // the functionality for wrapping block comments is written here,
                                // but currently disabled.  It demands a bit more finesse to prevent
                                // violation of JSLint and some mutilation of white space styles
                                if (spacely === true) {
                                    len  = comment.length;
                                    starti = 0;
                                    if ((/\s/).test(comment.charAt(0)) === true) {
                    ...
                    if (line === true) {
                        comment = comment.replace(/\s\/\//g, " ").replace(/(\s+)$/, "");
                    } else {
                    ...
                    if (ltype === "comment" && ptype !== "comment-inline" && options.wrap > 0 && empty.test(comment) === false && (comment.length > options.wrap || prior.indexOf("//") === 0)) {
                        ...
                        if (comment.length > options.wrap - 2) {
                            ...
                            if (line === true) {
                                ...
                                ltoke = "/* " + comment.replace(/^(\s+)/, "").replace(/(\s+)$/, "") + " */";
                            }
                            tokenpush(false, 0);
                        }
                        if (vartest !== "") {
                ...
                strlen         = function jspretty__tokenize_strlen(item) {
                    ...
                    if (item.length > options.wrap + 2) {
                        ...
                        item = item.slice(1, item.length - 1);
                        bb   = Math.floor(item.length / options.wrap) * options.wrap;
                        for (aa = 0; aa < bb; aa += options.wrap) {
                            cc = aa + options.wrap + dd;
                            if (item.charAt(cc - 6) !== "\\" && item.charAt(cc - 5) === "\\" && uchar.test(item.slice(cc - 4, cc + 1)) === true) {
                                ff = 5;
                                cc -= 5;
                            } else if (item.charAt(cc - 5) !== "\\" && item.charAt(cc - 4) === "\\" && uchar.test(item.slice(cc - 3, cc + 2)) === true) {
                                ff = 4;
                                cc -= 4;
                            } else if (item.charAt(cc - 4) !== "\\" && item.charAt(cc - 3) === "\\" && (uchar.test(item.slice(cc - 2, cc + 3)) === true || xchar.test(item.slice(cc - 2, cc + 1)) === true)) {
                                ff = 3;
                                cc -= 3;
                            } else if (item.charAt(cc - 3) !== "\\" && item.charAt(cc - 2) === "\\" && (uchar.test(item.slice(cc - 1, cc + 4)) === true || xchar.test(item.slice(cc - 1, cc + 2)) === true)) {
                                ff = 2;
                                cc -= 2;
                            } else if (item.charAt(cc - 2) !== "\\" && item.charAt(cc - 1) === "\\" && (uchar.test(item.slice(cc, cc + 5)) === true || xchar.test(item.slice(cc, cc + 3)) === true)) {
                                ff = 1;
                                cc -= 1;
                            } else {
                                ff = 0;
                ...
                newarray       = function jspretty__tokenize_newarray() {
                    ...
                    if (token[aa] === "(" && token[aa - 1] === "Array" && token[aa - 2] === "new") {
                        if (cc - aa === 1 && (/^([0-9])$/).test(token[cc]) === true) {
                            ...
                            begin[begin.length - 1] = token.length - 1;
                            do {
                                tokenpush(true, 0);
                                arraylen -= 1;
                            } while (arraylen > 0);
                ...
                operator       = function jspretty__tokenize_operator() {
                    ...
                    if (c[a] === "?" && c[a + 1] === ":" && syntax.join("").indexOf(c[a + 2]) < 0) {
                        return "?";
                    }
                    if (a < b - 1) {
                        if (c[a] !== "<" && c[a + 1] === "<") {
                ...
                markup         = function jspretty__tokenize_markup() {
                    ...
                    if (syntaxnum.indexOf(c[a + 1]) > -1 || token[d] === "++" || token[d] === "--" || (/\s/).test(c[a + 1]) === true || ((/\d/).test(c[a + 1]) === true && (ltype === "operator" || ltype === "literal" || (ltype === "word" && ltoke !== "return")))) {
                        ltype = "operator";
                        return operator();
                    }
                            ...
                            for (d = a + 2; d < b; d += 1) {
                                ...
                                if (c[d] === ",") {
                                    ...
                                    if (e === 0 && f === 0) {
                                        ...
                                        ltype = "generic";
                                        a = d;
                                        return generics.join("").replace(/\s+/g, " ");
                                    }
                                }
                        ...
                        if (c[a] === "{") {
                            ...
                            if (anglecount === 0 && curlycount === 0 && tagcount < 1) {
                                ...
                                if (next.charAt(0) === "<" && syntaxnum.indexOf(next.charAt(1)) < 0 && (/\s/).test(next.charAt(1)) === false) {
                                    //perform a minor safety test to verify if "<" is a tag start or a less than operator
                                    d = a + 1;
                                    do {
                                        d += 1;
                ...
                //operations for end types: ), ], }
                    ...
                    if (x === ")") {
                        ...
                        if (lword.length > 0) {
                            ...
                            if (pword.length > 1 && nextchar() !== "{" && (pword[0] === "if" || pword[0] === "for" || (pword[0] === "while" && depth[pword[1] - 2] !== undefined && depth[pword[1] - 2] !== "do") || pword[0] === "with")) {
                                insert = true;
                            }
                        }
                    } else if (x === "]") {
            ...
            for (a = 0; a < b; a += 1) {
                ...
                } else if (c[a] === "*" && depth[lengtha - 1] === "object" && (/\s/).test(c[a + 1]) === false && c[a + 1] !== "=") {
                    wordTest = a;
            ...
            return (function jspretty__parse() {
                var a      = 0,
                    ...
                    def    = {
                        ...
                        types: "string - Data types of the tokens: comment, comment-inline, end, literal, markup" +
                                   ", operator, regex, separator, start, template, template_else, template_end, temp" +
                                   "late_start, word"
                    };
                for (a = 0; a < c; a += 1) {
                    if (options.correct === false && (token[a] === "x;" || token[a] === "x{" || token[a] === "x}")) {
                        c -= 1;
                        begin.splice(a, 1);
                        depth.splice(a, 1);
                        lines.splice(a, 1);
                    ...
                    if (options.parseFormat !== "htmltable" && types[a] === "markup" && global.prettydiff.markuppretty !== undefined) {
                        ...
                        options.jsx    = true;
                        token[a]       = global.prettydiff.markuppretty(options).data;
                    }
                }
                if (options.parseFormat === "sequential") {
                    for (a = 0; a < c; a += 1) {
                        record.push([token[a], types[a], depth[a], begin[a], lines[a]]);
                    }
                    if (options.nodeasync === true) {
                        return [
                            {
                ...
                if (options.parseFormat === "htmltable") {
                    return (function jspretty__parse_html() {
                        var output = [],
                            header = "<tr class=\"header\"><th>index</th><th>token</th><th>types</th><th>depth</th><th>begin</th><th>lines</th></tr>",
                            aa     = 0,
                            len    = 0;
                        ...
                        for (aa = 0; aa < len; aa += 1) {
                            if (types[aa] === "markup" && global.prettydiff.markuppretty !== undefined) {
                                ...
                                output.push(global.prettydiff.markuppretty(options).data.replace("<thead>", "<thead><tr><th colspan=\"10\" class=\"nested\">markup tokens</th></tr>"));
                                output.push("</td></tr>");
                                output.push("<tr><th colspan=\"6\" class=\"nested\">JavaScript tokens</th></tr>");
                                output.push(header);
                            } else {
                                output.push("<tr><td>");
                                output.push(aa);
                                output.push("</td><td>");
                                output.push(token[aa].replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;"));
                                output.push("</td><td>");
        ...
        if (options.mode === "beautify" || options.mode === "diff") {
            ...
            (function jspretty__beautify() {
                var a           = 0,
                    ...
                    superindent = 0, //a flag for a collision of issues that requires more than normal indentation
                    ...
                    jsxmethod   = [], //are we in a long argument list of a JSX method
                    ...
                    tern        = function jspretty__beautify_tern(x) {
                        var aa       = 0,
                            bb       = begin[a],
                            lasttest = false;
                        if (ternary.length < 1 || ternary[ternary.length - 1] < begin[a] || options.ternaryline === true) {
                            return;
                        }
                                ...
                                if (ctoke === ":") {
                                    if (x > -1 && ternary[aa] === x) {
                                        ...
                                        if (token[ternary[aa]] === "?") {
                                            ...
                                            if (ternary.length > 1 && ternary[aa - 1] > begin[a]) {
                    ...
                    destructfix = function jspretty__beautify_destructFix(listFix, override) {
                        ...
                        var c          = 0,
                            d          = (listFix === true)
                                ? 0
                                : 1,
                            arrayCheck = (override === false && depth[a] === "array" && listFix === true && ctoke !== "[");
                        ...
                        for (c = a - 1; c > -1; c -= 1) {
                            ...
                            if (d === 0) {
                                if (depth[a] === "class" || depth[a] === "map" || (arrayCheck === false && ((listFix === false && token[c] !== "(") || (listFix === true && token[c] === ",")))) {
                    ...
                    separator   = function jspretty__beautify_separator() {
                        var methtest      = false,
                            functest      = false,
                            funcargs      = false,
                            propertybreak = function jspretty__beautify_separator_propertybreak(funcarg) {
                                var c = 0,
                                    d = 0,
                                    e = 0;
                        ...
                        if (ctoke === ".") {
                            if (token[begin[a]] !== "(" && methodbreak[methodbreak.length - 1] === true) {
                            ...
                            if ((options.methodchain === "chain" || (options.methodchain === "none" && lines[a] < 1)) && ltype !== "comment" && ltype !== "comment-inline") {
                                ...
                                if (token[begin[a]] !== "(" && (ltoke === ")" || methodbreak[methodbreak.length - 1] === true || (types[a + 1] === "word" && depth[a + 2] === "method"))) {
                                    if (methodbreak[methodbreak.length - 1] === false) {
                                        funcargs = (function jspretty__beautify_separator_funcargs() {
                                            var aa        = 0,
                                                bb        = b,
                                                cc        = 0,
                                                firstmeth = false;
                                            for (aa = a + 1; aa < bb; aa += 1) {
                                                if (types[aa] === "end") {
                                                    ...
                                                    cc -= 1;
                                                    if (firstmeth === false && cc === -1 && depth[aa] === "method") {
                                                        firstmeth = true;
                                                    }
                                                }
                        ...
                        if (ctoke === ",") {
                            ...
                            if (depth[a] === "object") {
                                if (destruct[destruct.length - 1] === true && types[begin[a] - 1] !== "word" && token[begin[a] - 1] !== "(") {
                            ...
                            if (jsxmethod[jsxmethod.length - 1] === false && options.jsx === true && depth[a] === "method") {
                                (function jspretty__beautify_separator_jsxmethod() {
                                    var aa = begin[a] + 1,
                                        bb = 0,
                                        cc = false;
                                    do {
                                        bb += token[aa].length;
                                        aa += 1;
                                        cc = (token[aa] === ")" && begin[aa] === begin[a]);
                                    } while (token[aa] !== undefined && cc === false && bb < options.wrap);
                                    if (bb < options.wrap) {
                                        return;
                                    }
                                    jsxmethod[jsxmethod.length - 1] = true;
                                }());
                            }
                            if (jsxmethod[jsxmethod.length - 1] === true) {
                    ...
                    start       = function jspretty__beautify_start() {
                        ...
                        if (ltoke === ")" || ((deeper === "object" || deeper === "array") && ltoke !== "]")) {
                            if (deep !== "method" || (deep === "method" && token[a + 1] !== ")" && token[a + 2] !== ")")) {
                                if (ltoke === ")" && (deep !== "function" || token[begin[begin[a - 1] - 1]] === "(")) {
                                    destructfix(false, false);
                        ...
                        arrbreak.push(false);
                        jsxmethod.push(false);
                        wordlist.push(false);
                        itemcount.push(0);
                        varlen.push([]);
                        if (options.neverflatten === true || options.qml === true || deep === "attribute" || (deep === "class" && ltoke !== "(") || (ctoke === "[" && token[a + 1] === "function")) {
                            destruct.push(false);
                        } else {
                            if (deep === "expression" || deep === "method") {
                                destruct.push(true);
                            } else if ((deep === "object" || deep === "class") && (ltoke === "(" || ltype === "word")) {
                        ...
                        if (ctoke === "{" || ctoke === "x{") {
                            ...
                            if (types[a - 1] !== "comment" && types[a - 1] !== "comment-inline") {
                                if (ltype === "markup") {
                                    ...
                                    level[a - 1] = indent - 1;
                                } else if (deep === "function" || ltoke === ")" || ltoke === "," || ltoke === "}" || ltype === "markup") {
                                    level[a - 1] = "s";
                                    ...
                                    for (c = a - 1; c > -1; c -= 1) {
                                        ...
                                        if (d === 1) {
                                            ...
                                            if ((c === 0 || token[c - 1] === "{" || token[c - 1] === "x{") || token[c] === "for" || token[c] === "if" || token[c] === "do" || token[c] === "function" || token[c] === "while" || token[c] === "var" || token[c] === "let" || token[c] === "const" || token[c] === "with") {
                                                if (list[listlen - 1] === false && listlen > 1 && (a === b - 1 || token[a + 1] !== ")") && depth[a] !== "object") {
                                                    indent -= 1;
                                                }
                                                if (varline[varline.length - 1] === true) {
                                                    indent -= 1;
                        ...
                        if (options.bracepadding === true && ltype !== "start" && ltoke !== ";" && (level[begin[a]] === "x" || level[begin[a]] === "s" || destruct[destruct.length - 1] ===  true)) {
                            level[begin[a]] = "s";
                            level[a - 1] = "s";
                            level.push("x");
                        } else if (options.qml === true) {
                            if (ltype === "start" || ctoke === ")") {
                                level[a - 1] = "x";
                            } else {
                                level[a - 1] = indent;
                            }
                            ...
                            level[a - 1] = "x";
                            level.push(indent);
                        } else if (ctoke === "]" && (methodbreak[methodbreak.length - 1] === true || arrbreak[arrbreak.length - 1] === true)) {
                            level[a - 1] = indent;
                            level.push("x");
                        } else if (ctoke === ")" && jsxmethod[jsxmethod.length - 1] === true) {
                            level[a - 1] = indent;
                            level.push("x");
                    ...
                    operator    = function jspretty__beautify_operator() {
                        ...
                        if (ctoke !== ":" && token[begin[a]] !== "(" && destruct.length > 0) {
                            destructfix(true, false);
                        }
                        if (ctoke === "!" || ctoke === "...") {
                            if (ltoke === "(") {
                        ...
                        if (ctoke === "?") {
                            if (lines[a] === 0 && types[a - 2] === "word" && token[a - 2] !== "return" && token[a - 2] !== "in" && token[a - 2] !== "instanceof" && token[a - 2] !== "typeof" && ltype === "word") {
                                if (types[a + 1] === "word" || (token[a + 1] === "(" && token[a - 2] === "new")) {
                                    level[a - 1] = "x";
                                    if (types[a + 1] === "word") {
                                        return level.push("s");
                                    }
                            ...
                            if (options.ternaryline === true) {
                                ...
                                if (ternary.length > 0 && token[ternary[ternary.length - 1]] === ":" && ternary[ternary.length - 1] > begin[a]) {
                        ...
                        if (ctoke === ":") {
                            ...
                            if ((token[a - 2] === "var" || token[a - 2] === "let" || token[a - 2] === "const" || token[a - 2] === "," || (depth[a] === "global" && options.jsx === true && ternary.length < 1)) && ltype === "word" && depth[a] !== "paren") {
                                level[a - 1] = "x";
                                if (depth[a] === "object" || varline[varline.length - 1] === true) {
                            ...
                            if (ltoke === ")" && token[begin[a - 1] - 2] === "function") {
                                level[a - 1] = "x";
                                return level.push("s");
                            }
                            if (depth[a] === "attribute") {
                            ...
                            if ((ltype === "word" || ltoke === ")" || ltoke === "]" || ltoke === "?") && (depth[a] === "map" || depth[a] === "class" || types[a + 1] === "word") && (ternary.length === 0 || ternary[ternary.length - 1] < begin[a]) && ("mapclassexpressionmethodglobalparen".indexOf(depth[a]) > -1 || (types[a - 2] === "word" && depth[a] !== "switch"))) {
                                level[a - 1] = "x";
                                varlen[varlen.length - 1].push(a - 1);
                                return level.push("s");
                            }
                        ...
                        if (ctoke === "+") {
                            if (ltoke.length < options.wrap + 3 && (ltoke.charAt(0) === "\"" || ltoke.charAt(0) === "'") && (token[a + 1].charAt(0) === "\"" || token[a + 1].charAt(0) === "'")) {
                                ...
                                if (list[list.length - 1] === true || depth[a] === "object" || depth[a] === "method" || depth[a] === "global" || ((token[a - 1].charAt(0) === "\"" || token[a - 1].charAt(0) === "'") && (token[a - 2] === "+" || token[a - 2].indexOf("=") > -1 || types[a - 2] === "start"))) {
                                    if (superindent === 0) {
                                        (function jspretty__beautify_operator_stringBreak() {
                                            var c = a,
                                                d = 0;
                                            superindent = indent + 2;
                                            for (c = a; c > 0; c -= 1) {
                                                if (d === 0 && types[c] === "separator") {
                                                    if (token[c] === "." && level[c - 1] !== "s" && level[c - 1] !== "x") {
                                                        superindent = indent + 3;
                                                    }
                                                    return;
                                                }
                                                if (types[c] === "start") {
                        ...
                        if (ctoke === "*" && depth[a] === "object" && types[a + 1] === "word" && (ltoke === "{" || ltoke === ",")) {
                            level[a - 1] = indent;
                        } else if (ltype !== "comment" && ltype !== "comment-inline" && (ctoke !== "?" || ternary.length === 0)) {
                            level[a - 1] = "s";
                        }
                        if (ctoke.indexOf("=") > -1 && ctoke !== "==" && ctoke !== "===" && ctoke !== "!=" && ctoke !== "!==" && ctoke !== ">=" && ctoke !== "<=" && depth[a] !== "method" && depth[a] !== "object") {
                    ...
                    word        = function jspretty__beautify_word() {
                        ...
                        if (varline[varline.length - 1] === true && (ltoke === "," || ltoke === "var" || ltoke === "let" || ltoke === "const")) {
                            if (token[begin[a] - 1] !== "for" && depth[a] !== "method") {
                        ...
                        if (ltoke === ")" && depth[a] === "class" && (token[begin[a - 1] - 1] === "static" || token[begin[a - 1] - 1] === "final" || token[begin[a - 1] - 1] === "void")) {
                            level[a - 1] = "s";
                            level[begin[a - 1] - 1] = "s";
                        }
                        if (ltoke === "]") {
                        ...
                        if (depth[a] === "object" && (ltoke === "{" || ltoke === ",") && token[a + 1] === "(") {
                            return level.push("x");
                        }
                        level.push("s");
                    };
            ...
            if (options.jsscope !== "none") {
                result = (function jspretty__resultScope() {
                    var a           = 0,
                        ...
                        endcomma_multiline = function jspretty__resultScope_endcommaMultiline() {
                           var c = a;
                            ...
                            var aa          = 0,
                                ...
                                joins       = function jspretty__resultScope_varSpaces_joins(x, vars) {
                                    var xlen    = token[x].length,
                                        ...
                                        words   = function jspretty__resultScope_varSpaces_joins_wordsInit() {
                                            return;
                                        },
                                        extref  = function jspretty__resultScope_varSpaces_joins_extref() {
                                            return;
                                        };
                                    period = function jspretty__resultScope_varSpaces_joins_period() {
                                        ...
                                        if (types[x] === "word" && (types[x - 1] === "word" || types[x - 1] === "generic") && token[x - 1] !== "var" && token[x - 1] !== "let" && token[x - 1] !== "const") {
                                            words();
                                        }
                                    };
                                    ending = function jspretty__resultScope_varSpaces_joins_ending() {
                                        ...
                                        for (x -= 1; x > -1; x -= 1) {
                                            ...
                                            if (types[x - 1] === "comment" || types[x - 1] === "comment-inline") {
                                                xlen += 1;
                                                return;
                                            }
                                            if (types[x] === "end") {
                                        ...
                                        if (token[x - 1] === ")" || token[x - 1] === "]") {
                                            if ((token[x] === "[" && token[x + 1] !== "]") || (token[x] === "(" && token[x + 1] !== ")")) {
                                                xlen -= 1;
                                            }
                                            extref();
                                        }
                                    ...
                                    extref = ending;
                                    words  = function jspretty__resultScope_varSpaces_joins_words() {
                                        do {
                                            if (types[x - 1] === "generic") {
                                                x -= 1;
                                                xlen += token[x].length;
                                            }
                                            x -= 1;
                                            xlen += token[x].length;
                                            xlen += 1;
                                        } while (types[x - 1] === "word" && token[x - 1] !== "var" && token[x - 1] !== "let" && token[x - 1] !== "const");
                                        if (token[x - 1] === "]" || token[x - 1] === ")") {
                                            ending();
                                        } else if (token[x - 1] === ".") {
                                            if (level[x - 2] === "x") {
                                    ...
                                    if (token[x] === "?" && types[x - 1] === "word") {
                                        xlen += token[x - 1].length;
                                        x -= 1;
                                    }
                                    if (types[x] === "generic") {
                                        x -= 1;
                                    ...
                                    if (types[x] === "word" && (token[x - 1] === "]" || token[x - 1] === ")")) {
                                        x -= 1;
                                        xlen += 1;
                                        ending();
                                    } else if (types[x] === "word" && (types[x - 1] === "word" || types[x - 1] === "generic") && token[x - 1] !== "var" && token[x - 1] !== "let" && token[x - 1] !== "const") {
                                        words();
                                    } else if (types[x] === "word" && token[x - 1] === ".") {
                                        if (level[x - 2] === "x") {
                                            period();
                                        } else {
                                            xlen += (options.inchar.length * options.insize) + 2;
                    ...
                    for (a = 0; a < b; a += 1) {
                        ...
                        if (options.endcomma === "multiline" && (token[a + 1] === "]" || token[a + 1] === "}") && level[a] !== "x") {
                            endcomma_multiline();
                        }
                        if (types[a] === "comment" && token[a].indexOf("/*") === 0) {
                ...
                result = (function jspretty__result() {
                    var a             = 0,
                        ...
                        markupwrapper = function jspretty__result_markupwrapper() {
                            ...
                            options.jsx    = true;
                            options.mode   = "beautify";
                            if (level[a] === "x" || level[a] === "s" || depth[a] === "array") {
                        ...
                        endcomma_multiline = function jspretty__result_endcommaMultiline() {
                           var c = a;
                           if (types[c] === "comment" || types[c] === "comment-inline") {
                               do {
                                   c -= 1;
                            ...
                            var aa          = 0,
                                ...
                                joins       = function jspretty__result_varSpaces_joins(x, vars) {
                                    var xlen    = token[x].length,
                                        ...
                                        words   = function jspretty__result_varSpaces_joins_wordsInit() {
                                            return;
                                        },
                                        extref  = function jspretty__result_varSpaces_joins_extref() {
                                            return;
                                        };
                                    ...
                                    words  = function jspretty__result_varSpaces_joins_words() {
                                        do {
                                            if (types[x - 1] === "generic") {
                                                x -= 1;
                                                xlen += token[x].length;
                                            ...
                                            xlen += token[x].length;
                                            xlen += 1;
                                        } while ((types[x - 1] === "word" || types[x - 1] === "generic") && token[x - 1] !== "var" && token[x - 1] !== "let" && token[x - 1] !== "const");
                                        if (token[x - 1] === "]" || token[x - 1] === ")") {
                                            ending();
                                        } else if (token[x - 1] === ".") {
                                            if (level[x - 2] === "x") {
                    ...
                    for (a = 0; a < b; a += 1) {
                        ...
                        if (types[a] === "comment" || (token[a] !== "x;" && token[a] !== "x{" && token[a] !== "x}")) {
                            if (types[a] === "markup") {
                                if (level[a - 1] !== "x" && level[a - 1] !== "s" && token[a - 1] !== "return" && depth[a] !== "global" && depth[a] !== "array") {
                                    build.push(tab);
                                }
                                if (typeof global.prettydiff.markuppretty === "function") {
                                    markupwrapper();
                        ...
                        // options.preserve determines whether empty lines should be preserved from the
                        // code input
                        if (options.preserve > 0 && ((lines[a] > 0 && level[a] !== "x" && level[a] !== "s" && token[a] !== "+" && options.qml === false) || (options.qml === true && lines[a] > 1))) {
                            if (options.qml === true) {
                                do {
                                    build.push(lf);
                                    lines[a] -= 1;
            ...
            if (options.mode === "analysis") {
                ...
                return (function jspretty__report() {
                    ...
                    if (error.length > 0) {
                        ...
                        output.push(error[0].replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(options.functions.binaryCheck, ""));
    ...
    if (typeof require === "function" && (typeof ace !== "object" || ace.prettydiffid === undefined)) {
        (function glib_jspretty() {
            ...
            if (global.prettydiff.markuppretty === undefined) {
                global.prettydiff.markuppretty = require(localPath + "/markuppretty.js");
            }
        }());
    }
    if (typeof module === "object" && typeof module.parent === "object") {
        ...
        define(function requirejs(require, module) {
            ...
            return function requirejs_jspretty_module(x) {
                return jspretty(x);
            };
        });
    } else {
