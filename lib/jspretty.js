...
var jspretty = function jspretty_(options) {
    ...
    (function jspretty__options() {
        ...
        options.wrap         = (isNaN(Number(options.wrap)) === true)
            ? 0
            : Number(options.wrap);
        verticalop           = (options.vertical === true || options.vertical === "false" || options.vertical === "all" || options.vertical === "js");
    }());
        ...
        var a              = 0,
            ...
            depthPush      = function jspretty__tokenize_depthPush() {
                ...
                if ((wordx === "else" && token[last] !== "if") || wordx === "do" || wordx === "try" || wordx === "finally" || wordx === "switch") {
                    ...
                    if (types[last - 1] === "word") {
                        depth.push(["notation", last]);
                    } else {
                        depth.push(["array", last]);
                    }
                } else if (token[last] === "(") {
                    if (wordx === "if" || wordx === "for" || wordx === "function" || wordx === "class" || wordx === "while" || wordx === "catch" || wordx === "switch" || wordx === "with") {
                        depth.push(["expression", last]);
                    } else if ((types[last - 1] === "word" && wordx !== "return") || wordx === "}") {
                            ...
                            if (keys.length > 1) {
                                ...
                                for (dd = 0; dd < keylen; dd += 1) {
                                    ...
                                    if (commaTest === false) {
                                        ...
                                        pairDepth.splice(ee, 0, depthlist[depthlist.length - 1]);
                                        pairLines[ee - 1] = 0;
                                    }
                                }
                                ee = pairTypes.length - 1;
            ...
            asi            = function jspretty__tokenize_asi(isEnd) {
                var len   = token.length - 1,
                    ...
                    cdeep = (depthlist.length === 0)
                        ? ""
                        : depthlist[depthlist.length - 1][0];
                if (cdeep === "method" || cdeep === "paren" || cdeep === "expression" || cdeep === "array" || cdeep === "object") {
                    return;
                }
            ...
            //operations for end types: ), ], }
                ...
                if (x === ")") {
                    ...
                    if (lword.length > 0) {
                        ...
                        if ((pword[0] === "if" || pword[0] === "for" || (pword[0] === "while" && depth[pword[1] - 2][0] !== "do") || pword[0] === "with") && nextchar() !== "{") {
                            insert = true;
                        }
                    }
                } else if (x === "]") {
                    ...
                    if (depthlist[depthlist.length - 1][0] !== "object") {
                        asi(true);
            ...
            var a           = 0,
                ...
                separator   = function jspretty__algorithm_separator() {
                    ...
                    if (ctoke === ".") {
                        if (options.methodchain === true && ltype !== "comment" && ltype !== "comment-inline") {
                            ...
                            if (starttype[starttype.length - 1] !== "paren" && starttype[starttype.length - 1] !== "method" && (ltoke === ")" || methodbreak[methodbreak.length - 1] === true || (types[a + 1] === "word" && depth[a + 2][0] === "method"))) {
                ...
                start       = function jspretty__algorithm_start() {
                    ...
                    if (ctoke === "{" || ctoke === "x{") {
                        ...
                        if (depth[a - 1][0] === "method" && ltoke === ")") {
                            if (token[depth[a - 1][1] - 2] !== "function") {
                                level[depth[a - 1][1] - 1] = "s";
                            }
                            if (token[depth[depth[a - 1][1] - 1][1]] === "{") {
                                level[depth[depth[a - 1][1] - 1][1]] = indent - 1;
                            }
                        } else if (token[depth[a - 1][1]] === "{") {
                            level[depth[a - 1][1]] = indent - 1;
                        }
                    ...
                    if (ctoke === "[") {
                        ...
                        if (depth[a][0] === "method" || destruct[destruct.length - 1] === true) {
                            return level.push("x");
                        }
                ...
                operator    = function jspretty__algorithm_operator() {
                    ...
                    if (ctoke.indexOf("=") > -1 && ctoke !== "==" && ctoke !== "===" && ctoke !== "!=" && ctoke !== "!==" && ctoke !== ">=" && ctoke !== "<=" && varlen.length > 0 && depth[a][0] !== "method" && depth[a][0] !== "object") {
                ...
                word        = function jspretty__algorithm_word() {
                    ...
                    if (varline.length === 1 && varline[0] === true && (ltoke === "var" || ltoke === "let" || ltoke === "const" || ltoke === "," || (ltoke === "function" && depth[a + 1][0] === "method"))) {
                        globals.push(ctoke);
                    }
                    ...
                    if (ctoke === "function" && options.space === false && a < b - 1 && token[a + 1] === "(") {
                        return level.push("x");
                    }
            ...
            for (a = 0; a < b; a += 1) {
                ...
                if (ctype === "comment") {
                    ...
                    if (ltoke === "return" || ltoke === "?" || ltoke === ":") {
                        level[a - 1] = "s";
                        level.push("x");
                    } else if (ltype === "start" || (token[a - 2] === "return" && depth[a - 1][0] === "method")) {
                        level.push(indent);
                    } else {
                        level.push("x");
                    }
                        ...
                        if (types[aa] === "word" && (token[aa + 1] !== ":" || (token[aa + 1] === ":" && level[aa + 1] === "x")) && token[aa].indexOf("<em ") < 0) {
                            ...
                            for (ee = dd - 1; ee > -1; ee -= 1) {
                                if (word[0] === globalLocal[ee] && token[aa - 1] !== ".") {
                                    if (token[aa - 1] === "function" && depth[aa + 1][0] === "method") {
