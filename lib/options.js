...
(function options_init() {
    ...
    if (typeof require === "function" && (typeof ace !== "object" || ace.prettydiffid === undefined)) {
        (function glib_options() {
            ...
            if (global.prettydiff.language === undefined) {
                require([localPath + "/lib/language.js"], function prettydiff_langauge(code) {
                    global.prettydiff.language = code;
                });
            }
        }());
    }
    ...
    options.functions.validate      = function options_validate(api) {
        ...
        options.wrap            = (
            isNaN(api.wrap) === true || api.wrap === "" || options.mode === "diff" || options.textpreserve === true
        )
            ? 0
            : Number(api.wrap);
        options.autoval         = ["", "", ""];
