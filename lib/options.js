...
(function options_init() {
    ...
    options.functions.default = function options_default() {
        var keys = Object.keys(options.functions.definitions),
            populate = function options_default_populate(name) {
                if (name !== "diff" && name !== "output" && name !== "source" && (options.functions.nodeArgs === undefined || options.functions.nodeArgs[name] === undefined)) {
    ...
    options.functions.consolePrint = function options_consolePrint() {
        ...
        if (options.api === "wsf") {
            output.push("\u001B[1mUsage\u001B[22m");
            output.push("\u001B[35cscript api\\prettydiff.wsf\u001B[39m \u001B[32/source:\u001B[39m\u001B[33m\"myFile.xml\"\u001B[39m \u001B[32/diff:\u001B[39m\u001B[33m\"myOtherFile.xml\"\u001B[39m \u001B[32/output:\u001B[39m\u001B[33m\"outFile.xml\"");
            output.push("\u001B[35cscript api\\prettydiff.wsf\u001B[39m \u001B[32/source:\u001B[39m\u001B[33m\"myFile.xml\"\u001B[39m \u001B[32/mode:\u001B[39m\u001B[33m\"beautify\"\u001B[39m \u001B[32/output:\u001B[39m\u001B[33m\"outFile.xml\"");
        }
        output.push("");
    ...
    options.functions.validate = function options_validate(api) {
        ...
        options.help           = (isNaN(api.help) === true)
            ? 80
            : Number(api.help);
