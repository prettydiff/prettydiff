                        ...
                        var findings   = [],
                            tagsbyname = function markuppretty__apply_summary_accessibility_tagsbyname() {
                                ...
                                for (b = 0; b < c; b += 1) {
                                    ...
                                    if (types[b] === "start" || types[b] === "template_start") {
                                        ...
                                        if (tagname !== "/" + namestack[namestack.length - 1][0]) {
                                            ...
                                            badnest.push(namestack[namestack.length - 1]);
                                        }
                                        namestack.pop();
                                    }
                                ...
                                if (b > 0) {
                                    ...
                                    attr.push("</h4> <ol>");
                                    for (x = 0; x < b; x += 1) {
                                        attr.push("<li>End tag <code>");
                                        attr.push(token[badnest[x][2]].replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"));
                                        attr.push("</code> on input line number ");
                                        attr.push(linen[badnest[x][2]]);
                                        attr.push(" does not match start tag <code>");
                                        attr.push(token[badnest[x][1]].replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"));
                                        attr.push("</code> from input line number ");
                                        attr.push(linen[badnest[x][1]]);
                                        attr.push("</li>");
                                    }
                                    attr.push("</ol>");
                                }
