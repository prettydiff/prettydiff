...
global.prettydiff.markuppretty = function markuppretty_(options) {
    "use strict";
            ...
            var len           = token.length,
                ...
                parseErrors   = (function markuppretty__apply_summary_parseErrors() {
                    ...
                    if (parseError.length > 1) {
                        globalerror     = parseError[0].replace(options.binaryCheck, "");
                    }
                    if (x === 0) {
                        return "";
                    }
                    ...
                    for (y = 0; y < x; y += 1) {
                        fails.push("<li>");
                        fails.push(parseError[y].replace(options.binaryCheck, "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace("element: ", "element: <code>"));
                        fails.push("</code></li>");
                    }
                    fails.push("</ol>");
                    return fails.join("");
                ...
                zipf          = (function markuppretty__apply_summary_zipf() {
                    ...
                    wordlist = safeSort(wordlist.join(" ").replace(options.binaryCheck, "").toLowerCase().replace(/&nbsp;/gi, " ").replace(/(,|\.|\?|!|:|\(|\)|"|\{|\}|\[|\])/g, "").replace(/\s+/g, " ").replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").split(" "));
...
if (typeof module === "object" && typeof module.parent === "object") {
    ...
    module.exports = global.prettydiff.markuppretty;
    ...
    define(function requirejs(require, module) {
        ...
        return function requirejs_markuppretty_module(x) {
            global.prettydiff.markuppretty(x);
        };
    });
}
