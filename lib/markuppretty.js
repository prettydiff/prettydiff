...
var markuppretty = function markuppretty_(options) {
    ...
    (function markuppretty__options() {
        ...
        options.externalMarkup  = (typeof options.externalMarkup !== "string")
            ? ""
            : options.externalMarkup;
    ...
    //options.externalMarkup = "node api/node-local.js readmethod:\"screen\" source:\"\" mode:\"beautify\"";
    //type definitions:
    // * start      end     type
    // * <![CDATA[   ]]>     cdata
    // * <!--       -->     comment
    ...
    output = (function markuppretty__beautify() {
        ...
        level[0] = 0;
        c = external_in.length;
        if (options.externalMarkup === "" || c === 0) {
            return apply();
        }
        //for (a = 0; a < c; a += 1) {
