        ...
        var a        = 0,
            ...
            tag      = function markuppretty__tokenize_tag(end) {
                ...
                cheat = (function markuppretty__tokenize_tag_cheat() {
                    ...
                    if (options.html === true) {
                        ...
                        if (tname === "area" || tname === "base" || tname === "basefont" || tname === "br" || tname === "col" || tname === "embed" || tname === "eventsource" || tname === "frame" || tname === "hr" || tname === "img" || tname === "input" || tname === "keygen" || tname === "link" || tname === "meta" || tname === "param" || tname === "progress" || tname === "source" || tname === "wbr") {
                            return true;
                        }
                    }
            ...
            content  = function markuppretty__tokenize_content() {
                ...
                for (a; a < c; a += 1) {
                    ...
                    if (ext === false && output.length > 0 && (b[a] === "<" || (b[a] === "[" && b[a + 1] === "%") || (b[a] === "{" && (options.jsx === true || options.dustjs === true || b[a + 1] === "{" || b[a + 1] === "%" || b[a + 1] === "@" || b[a + 1] === "#")))) {
