...
(function markuppretty_init() {
    ...
    var markuppretty = function markuppretty_(options) {
        var safeSort    = global.prettydiff.safeSort,
            ...
            // * value attribute value if current type is attribute and options.attributetoken is true
            attrs       = [],
            jscom       = [],
            level       = [],
            linen       = [],
            ...
            extlib      = function markuppretty__extlib(type) {
                var result = (type === "script")
                    ? global.prettydiff.jspretty(options)
                    : global.prettydiff.csspretty(options);
        ...
        (function markuppretty__tokenize() {
            var a             = 0,
                ...
                tag           = function markuppretty__tokenize_tag(end) {
                    ...
                    (function jspretty__tokenize_types() {
                        if (end === "]>") {
                            end      = ">";
                            sgmlflag -= 1;
                    ...
                    igcount = 0;
                    element = lexer.join("");
                    if (element.slice(0, 2) === "<%" && element.slice(element.length - 2) === "%>") {
                    ...
                    attrs.push(function jspretty__tokenize_attribute() {
                        var ind = 0,
                            len = attstore.length,
                            obj = {},
                            eq  = 0,
                    ...
                    cheat = (function markuppretty__tokenize_tag_cheat() {
                        ...
                        for (d = attstore.length - 1; d > -1; d -= 1) {
            ...
            return (function markuppretty__parse() {
                ...
                for (a = 0; a < c; a += 1) {
                    ...
                    if (options.parseFormat !== "htmltable") {
                        if (types[a] === "script" && global.prettydiff.jspretty !== undefined) {
                            options.source = token[a];
                            token[a]       = global.prettydiff.jspretty(options).data;
                        } else if (types[a] === "style" && global.prettydiff.csspretty !== undefined) {
                            options.source = token[a];
                            token[a]       = global.prettydiff.csspretty(options).data;
                        }
                    }
                ...
                if (options.parseFormat === "htmltable") {
                    return (function csspretty__parse_html() {
                        ...
                        for (aa = 0; aa < len; aa += 1) {
                            if (types[aa] === "script" && global.prettydiff.jspretty !== undefined) {
                                options.source = token[aa];
                                report.push("<tr><td colspan=\"10\" class=\"nested\">");
                                report.push(global.prettydiff.jspretty(options).data.replace("<thead>", "<thead><tr><th colspan=\"6\" class=\"nested\">JavaScript tokens</th></tr>"));
                                report.push("</td></tr>");
                                report.push("<tr><th colspan=\"10\" class=\"nested\">Markup tokens</th></tr>");
                                report.push(header);
                            } else if (types[aa] === "style" && global.prettydiff.csspretty !== undefined) {
                                options.source = token[aa];
                                report.push("<tr><td colspan=\"10\" class=\"nested\">");
                                report.push(global.prettydiff.csspretty(options).data.replace("<thead>", "<thead><tr><th colspan=\"4\" class=\"nested\">CSS tokens</th></tr>"));
                                report.push("</td></tr>");
                                report.push("<tr><th colspan=\"10\" class=\"nested\">Markup tokens</th></tr>");
                                report.push(header);
                            } else {
                                ...
                                if (options.attributetoken === true) {
                                    ...
                                    report.push(value[aa].replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;"));
                                    report.push("</td><td>");
                                } else {
                                    report.push("<td style=\"white-space:pre\">");
                                    report.push(JSON.stringify(attrs[aa]).replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;"));
                                    report.push("</td><td>");
                                }
        ...
        output = (function markuppretty__beautify() {
            var a            = 0,
                ...
                apply        = function markuppretty__apply() {
                    var x            = 0,
                        ...
                        wrapper      = function markuppretty__apply_wrapper() {
                            ...
                            if (list.length > 0) {
                                ...
                                if ((types[x] === "template_start" || types[x] === "template" || types[x] === "template_else") && options.jsx === false && typeof global.prettydiff.jspretty === "function") {
                                    len = list.length;
                                    for (b = 0; b < len; b += 1) {
                                        xlen = list[b].indexOf("{");
                                        if (list[b].indexOf("}") > xlen && xlen > 0) {
                                            ...
                                            options.inlevel = lev;
                                            list[b]         = list[b].slice(0, xlen) + global.prettydiff.jspretty(options).replace(/^(\s+)/, "") + list[b].slice(list[b].indexOf("}") + 1);
                                        }
                                    }
                                }
                        ...
                        jsxattribute = function markuppretty__apply_jsxattribute() {
                            var attr     = Object.keys(attrs[x]),
                                b        = 0,
                                xx       = attr.length,
                                inlevel  = (level[x] === "x" || level[x] === "s" || level[x] < 1)
                                    ? options.inlevel + 1
                                    : level[x] + 1,
                                inle     = options.inlevel,
                                mode     = options.mode,
                        ...
                        attArray     = function markuppretty__apply_attArray() {
                    ...
                    for (x = 0; x < y; x += 1) {
                        ...
                        } else if (options.unformatted === false && options.mode === "beautify" && presv[x] === false && (attrib.length > 0 || (wrap > 0 && token[x].length > wrap)) && (types[x] === "content" || types[x] === "start" || types[x] === "singleton" || types[x] === "template_start" || types[x] === "template") && (types[x] !== "singleton" || token[x].charAt(0) !== "{")) {
                            wrapper();
            ...
            if (options.mode !== "minify") {
                for (a = 0; a < c; a += 1) {
                    if (twigStart.test(token[a]) === true && twigEnd.test(token[a]) === true && (/\D-+\D/).test(token[a]) === false && (/^(\{%\s*((comment)|(else))\s*)/).test(token[a]) === false) {
                        script(true);
                    }
                    if (types[a] === "start") {
                        level.push(indent);
            ...
            return (function markuppretty__apply_summary() {
                var len           = token.length,
                        ...
                        var findings   = [],
                            tagsbyname = function markuppretty__apply_summary_accessibility_tagsbyname() {
                                var b         = 0,
                                    ...
                                    html      = false,
                                    headtest  = (/^(h\d)$/),
                                    obsoleteAttr = ["alink", "align", "background", "border", "color", "compact", "face",
                                        "height", "language", "link", "nowrap", "size", "start", "text", "version", "vlink", "width"
                                    ],
                                    attr      = [],
                                    formID    = [],
                                    labelFor  = [],
                                        ...
                                        if (data.obsoleteTags[data.obsoleteTags.length - 1] !== b) {
                                            ...
                                            for (y = 0; y < z; y += 1) {
                                                if (typeof attrs[b][obsoleteAttr[y]] === "string") {
                                                    data
                                                        .obsoleteAttr
                                                        .push([b, obsoleteAttr[y]]);
                                                }
                                            }
                                        }
                                        if (typeof attrs[b].tabindex === "string") {
                                            tabindex = attrs[b].tabindex.slice(1, attrs[b].tabindex.length - 1);
                    ...
                    parseErrors   = (function markuppretty__apply_summary_parseErrors() {
                        ...
                        for (y = 0; y < x; y += 1) {
                            fails.push("<li>");
                            fails.push(parseError[y].replace(options.functions.binaryCheck, "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace("element: ", "element: <code>"));
                            fails.push("</code></li>");
                        }
                        fails.push("</ol>");
                        return fails.join("");
                    ...
                    zipf          = (function markuppretty__apply_summary_zipf() {
                        ...
                        wordlist = safeSort(wordlist.join(" ").replace(options.functions.binaryCheck, "").toLowerCase().replace(/&nbsp;/gi, " ").replace(/(,|\.|\?|!|:|\(|\)|"|\{|\}|\[|\])/g, "").replace(/\s+/g, " ").replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").split(" "));
    ...
    if (typeof require === "function" && (typeof ace !== "object" || ace.prettydiffid === undefined)) {
        (function glib_markuppretty() {
            ...
            if (global.prettydiff.safeSort === undefined) {
                global.prettydiff.safeSort = require(localPath + "/safeSort.js");
            }
            if (global.prettydiff.csspretty === undefined) {
                global.prettydiff.csspretty = require(localPath + "/csspretty.js");
            }
            if (global.prettydiff.jspretty === undefined) {
                global.prettydiff.jspretty = require(localPath + "/jspretty.js");
            }
        }());
    }
    if (typeof module === "object" && typeof module.parent === "object") {
        ...
        define(function requirejs(require, module) {
            ...
            return function requirejs_markuppretty_module(x) {
