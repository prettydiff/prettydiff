...
var markuppretty = function markuppretty_(options) {
        ...
        var a        = 0,
            ...
            tag      = function markuppretty__tokenize_tag(end) {
                ...
                if (element.slice(0, 2) === "{%") {
                    if (tname === "else" || tname === "elseif") {
                        types[e] = "template_else";
                    } else if (tname === "endautoescape" || tname === "endblock" || tname === "endembed" || tname === "endfilter" || tname === "endfor" || tname === "endif" || tname === "endmacro" || tname === "endsandbox" || tname === "endspaceless" || tname === "endverbatim") {
                        types[e] = "template_end";
                    } else if (tname === "autoescape" || tname === "block" || tname === "embed" || tname === "filter" || tname === "for" || tname === "if" || tname === "macro" || tname === "sandbox" || tname === "spaceless" || tname === "verbatim") {
    ...
    if (options.mode === "beautify" || options.mode === "diff") {
        (function markuppretty__beautify() {
            ...
            for (a = 0; a < c; a += 1) {
                if (twigStart.test(token[a]) === true && twigEnd.test(token[a]) === true) {
                    script(true);
                }
                if (types[a] === "start") {
                    level.push(indent);
