        ...
        var safeSort    = global.prettydiff.safeSort,
            ...
            extlib      = function markuppretty__extlib(type) {
                ...
                if (options.nodeasync === true) {
                    ...
                    if (options.mode === "parse") {
                        if (options.parseFormat === "htmltable") {
                            if (type === "script") {
                                return result[0].data.replace("<thead>", "<thead><tr><th colspan=\"6\" class=\"nested\">JavaScript tokens</th></tr>");
                            }
                            return result[0].data.replace("<thead>", "<thead><tr><th colspan=\"4\" class=\"nested\">CSS tokens</th></tr>");
                        }
                ...
                if (options.mode === "parse") {
                    if (options.parseFormat === "htmltable") {
                        if (type === "script") {
                            return result.data.replace("<thead>", "<thead><tr><th colspan=\"6\" class=\"nested\">JavaScript tokens</th></tr>");
                        }
                        return result.data.replace("<thead>", "<thead><tr><th colspan=\"4\" class=\"nested\">CSS tokens</th></tr>");
                    }
                    return result.data;
                }
                return result;
            ...
            var a            = 0,
                    ...
                    var b       = 0,
                        spanfix = function markuppretty__beautify_content_spanfix() {
                            ...
                            if (types[b] === "comment") {
                                do {
                                    b -= 1;
                                } while (types[b] === "comment" && lines[b] < 1);
                            }
                            if (lines[b] === 0 && tagName(token[b]) === "span" && (tagName(token[b - 1]) === "span" || tagName(token[b - 1]) === "/span")) {
                                do {
                                    level[b] = "x";
                                    b -= 1;
                                } while (b > 0 && lines[b] < 1 && (tagName(token[b]) === "span" || types[b] === "comment"));
                            }
                        };
                ...
                apply        = function markuppretty__beautify_apply() {
                                ...
                                if ((types[x] === "template_start" || types[x] === "template" || types[x] === "template_else") && options.jsx === false) {
                                    ...
                                    for (b = 0; b < len; b += 1) {
                                        ...
                                        if (list[b].indexOf("}") > xlen && xlen > 0) {
                                            ...
                                            options.inlevel = lev;
                                            list[b]         = list[b].slice(0, xlen) + extlib("script").replace(/^(\s+)/, "") + list[b].slice(list[b].indexOf("}") + 1);
                                        }
                                    }
                                }
                            ...
                            for (b = 0; b < xx; b += 1) {
                                if (attrs[x][attr[b]].charAt(0) === "{") {
                                    ...
                                    if (b < attrib.length - 1) {
                                        builder = lf + builder + attr[b].slice(0, attr[b].length - 1) + lf + builder;
                                    } else {
                    ...
                    for (x = 0; x < y; x += 1) {
                        ...
                        } else if (types[x] !== "content" && options.unformatted === false && options.mode === "beautify" && presv[x] === false && (attrib.length > 0 || (wrap > 0 && token[x].length > wrap)) && (types[x] === "content" || types[x] === "start" || types[x] === "singleton" || types[x] === "template_start" || types[x] === "template") && (types[x] !== "singleton" || token[x].charAt(0) !== "{")) {
                            wrapper();
        ...
        if (options.mode === "analysis") {
            ...
            return (function markuppretty__beautify_apply_summary() {
                var len           = token.length,
                    ...
                    accessibility = (function markuppretty__beautify_apply_summary_accessibility() {
                        var findings   = [],
                    ...
                    statistics    = (function markuppretty__beautify_apply_summary_statistics() {
                        var stat       = [],
                            ...
                            rowBuilder = function markuppretty__beautify_apply_summary_statistics_rowBuilder(type) {
