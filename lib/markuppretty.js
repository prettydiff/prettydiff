...
var markuppretty = function markuppretty_(args) {
    ...
    if (typeof require === "function" && typeof ace !== "object") {
        if (global.csspretty ===  undefined) {
            global.csspretty = require("./csspretty.js").api;
        }
        if (global.jspretty ===  undefined) {console.log(require);
            global.jspretty = require("./jspretty.js").api;
        }
        if (global.safeSort ===  undefined) {
            global.safeSort = require("./safeSort.js").api;
        }
    }
    //type definitions:
    //start      end     type
