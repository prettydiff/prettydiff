            ...
            codeBuild = function diffview__opcodes() {
                var table = {},
                    ...
                    equality = function diffview__opcodes_equality() {
                        ...
                        d = b;
                        do {
                            table[one[c]].one.splice(0, 1);
                            table[one[c]].two.splice(0, 1);
                            if (table[one[c]].one.length < 1 && table[one[c]].two.length < 1) {
                                delete table[one[c]];
                            }
                            c += 1;
                            d += 1;
                        } while (c < len && one[c] === two[d]);
                        fix(["equal", a, c, b, d]);
                        b = d - 1;
                        a = c - 1;
                    };
                ...
                do {
                    if (one[a] === two[b]) {
                        ...
                        c = a;
                        d = b;
                        if (table[one[a]].two.length < 1 && table[two[b]].one.length < 1) {
                            do {
                                table[one[c]].one.splice(0, 1);
                                if (table[one[c]].one.length < 1) {
                                    delete table[one[c]];
                                }
                                table[two[d]].two.splice(0, 1);
                                if (table[two[d]].two.length < 1) {
                                    delete table[two[d]];
                                }
                                c += 1;
                                d += 1;
                            } while (c < len && d < len && table[one[c]].two.length < 1 && table[two[d]].one.length < 1);
                            fix(["replace", a, c, b, d]);
                            a = c - 1;
                            b = d - 1;
                        } else if (table[one[a]].two.length < 1) {
                            do {
                                table[one[c]].one.splice(0, 1);
                                if (table[one[c]].one.length < 1) {
                                    delete table[one[c]];
                                ...
                                c += 1;
                            } while (c < len && table[one[c]].two.length < 1);
                            fix(["delete", a, c, -1, -1]);
                            a = c - 1;
                            b -= 1;
                        } else if (table[two[b]].one.length < 1) {
                            do {
                                table[two[d]].two.splice(0, 1);
                                if (table[two[d]].two.length < 1) {
                                    delete table[two[d]];
                                ...
                                d += 1;
                            } while (d < len && table[two[d]].one.length < 1);
                            fix(["insert", -1, -1, b, d]);
                            a -= 1;
                            b = d - 1;
                        } else if (table[one[a]].one.length - table[one[a]].two.length === 1 && one[a + 1] !== two[b + 2]) {
                            table[one[a]].one.splice(0, 1);
                            if (table[one[a]].one.length < 1) {
                                delete table[one[a]];
                            }
                            fix(["delete", a, a + 1, -1, -1]);
                            b -= 1;
                        } else if (table[two[b]].two.length - table[two[b]].one.length === 1 && one[a + 2] !== two[b + 1]) {
                            table[two[b]].two.splice(0, 1);
                            if (table[two[b]].two.length < 1) {
                                delete table[two[b]];
                            }
                            fix(["insert", -1, -1, b, b + 1]);
                            a -= 1;
                        } else {
                            do {
                                table[one[c]].one.splice(0, 1);
                                ...
                                if (one[c] !== two[d] && table[two[d]].one.length < 1 && table[two[d]].two.length < 1) {
                                    delete table[two[d]];
                                }
                                c += 1;
                                d += 1;
                            } while (c < len && d < len && table[one[c]].two.length > 0 && table[two[d]].one.length > 0);
                            fix(["replace", a, c, b, d]);
                            a = c - 1;
                            b = d - 1;
                        }
                    ...
                    var b             = 0,
                        ...
                        compare       = function diffview__report_charcomp_compare(start) {
                            ...
                            if (dataA[y] === dataB[x]) {
                                ...
                                if (options.diffspaceignore === true && (whitetest.test(dataA[y - 1]) === true || whitetest.test(dataB[x - 1]) === true)) {
                                    whitespace = true;
                                }
                            ...
                            if (dataA[x] === dataB[y]) {
                                ...
                                if (options.diffspaceignore === true && (whitetest.test(dataA[x - 1]) === true || whitetest.test(dataB[y - 1]) === true)) {
                                    whitespace = true;
                                }
