            ...
            codeBuild = function diffview__opcodes() {
                var table = {},
                    ...
                    fix   = function diffview__opcodes_fix(code) {
                        ...
                        if (prior !== undefined) {
                            if (prior[0] === code[0]) {
                                ...
                                return;
                            } else if (prior[0] === "insert" && prior[4] - prior[3] === 1) {
                                if (code[2] - code[1] === 1) {
                                    if (code[0] === "replace") {
                                        prior[0] = "replace";
                                        prior[1] = code[1];
                                ...
                                if (code[0] === "delete") {
                                    ...
                                    if (one[prior[2] - 1] === two[code[4] - 1]) {
                                        ...
                                        d -= 1;
                                        return;
                                    } else if (one[code[2] - 1] === two[prior[4] - 1] || one[code[2] - 1] === two[prior[4]]) {
                    ...
                    replacement = function diffview__opcodes_replacement() {
                        do {
                            ...
                            c += 1;
                            d += 1;
                        } while (c < len && d < len && table[one[c]].two > 0 && table[two[d]].one > 0);
                        fix(["replace", a, c, b, d]);
                        a = c - 1;
                        b = d - 1;
                    },
                    replaceUniques = function diffview__opcodes_replaceUniques() {
                        do {
                            ...
                            c += 1;
                            d += 1;
                        } while (c < len && d < len && table[one[c]].two < 1 && table[two[d]].one < 1);
                        fix(["replace", a, c, b, d]);
                        a = c - 1;
                        b = d - 1;
                    };
                ...
                do {
                    if (one[a] === two[b]) {
                        ...
                        c = a;
                        d = b;
                        /*if (one[a] !== two[b + 1] && one[a + 1] !== two[b + 1] && table[one[a + 1]].one > 1 && table[one[a + 1]].two > 1 && table[two[b + 1]].one > 0 && table[two[b + 1]].two > 0 && (table[one[a + 1]].one > 1 || table[one[a + 1]].two > 1)) {//console.log(a);
                            c += 1;
                            d += 1;
                            table[one[a]].one -= 1;
                            table[two[b]].two -= 1;
                            if (table[one[a]].one < 1 && table[one[a]].two < 1) {
                                delete table[one[a]];
                            }
                            if (table[two[b]].one < 1 && table[two[b]].two < 1) {
                                delete table[two[b]];
                            }
                            fix(["replace", a, c, b, d]);
                            do {
                            ...
                            fix(["delete", a + 1, c, -1, -1]);
                            a = c - 1;
                        } else if (one[a + 1] !== two[b] && one[a + 1] !== two[b + 1] && table[two[b + 1]].one > 1 && table[two[b + 1]].two > 1 && table[one[a + 1]].one > 0 && table[one[a + 1]].two > 0 && (table[two[b + 1]].one > 1 || table[two[b + 1]].two > 1)) {
                            c += 1;
                            d += 1;
                            table[one[a]].one -= 1;
                            table[two[b]].two -= 1;
                            ...
                            do {
                                table[two[d]].one -= 1;
                                if (table[two[d]].one < 1 && table[two[d]].two < 1) {
                                    delete table[two[d]];
                                }
                                d += 1;
                            } while (d < len && one[c] !== two[d]);
                            fix(["insert", -1, -1, b + 1, d]);
                            b = d - 1;
                    } else */if (table[one[a]].two < 1 && table[two[b]].one < 1) {
                            replaceUniques();
