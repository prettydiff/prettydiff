        ...
        var errorout      = 0,
            ...
            codeBuild = function diffview__opcodes() {
                var table = {},
                    ...
                    one   = one = (typeof options.source === "string")
                        ? lines(options.source)
                        : options.source,
                    two   = two = (typeof options.diff === "string")
                        ? lines(options.diff)
                        : options.diff,
                    len   = two.length,
                    a     = 0,
                ...
                do {
                    if (one[a] === two[b]) {
                        ...
                        b = b + (c - a) - 1;
                        a = c - 1;
                    } else if (table[two[b + 1]] !== undefined && table[two[b + 1]].one === 1 && table[two[b + 1]].two === 1) {
                        if (two[b + 1] === one[a]) {
                            codes.push(["insert", -1, -1, b, b + 1]);
                            a -= 1;
                        } else if (one[a + 1] === two[b]) {
                            codes.push(["delete", a, a + 1, -1, -1]);
                            b -= 1;
                        } else {
                            codes.push(["replace", a, a + 1, b, b + 1]);
                        }
                    } else {
                        if (table[one[a]] !== undefined && table[one[a]].two === 0) {
                            ...
                            do {
                                ...
                                c += 1;
                            } while (c < len && table[one[c]] !== undefined && table[one[c]].one > 1 && table[one[c]].two > 1);
                        ...
                        if (btest === false && ntest === false && typeof baseTextArray[baseStart] === "string" && typeof newTextArray[newStart] === "string") {
                            ...
                            if (repeat === false) {
                                if (baseStart < baseEnd) {
                                    ...
                                    } else if (baseTextArray[baseStart] === "" && newTextArray[newStart] !== "" && (options.diffspaceignore === false || newTextArray[newStart].replace(/\s+/g, "") !== "")) {
                                        data[1].push("empty");
                                    } else {
                                        data[1].push(change);
                                    }
                                ...
                                if (newStart < newEnd) {
                                    ...
                                    } else if (newTextArray[newStart] === "" && baseTextArray[baseStart] !== "" && (options.diffspaceignore === false || baseTextArray[baseStart].replace(/\s+/g, "") !== "")) {
                                        data[3].push("empty");
                                    } else {
                                        data[3].push(change);
                                    }
