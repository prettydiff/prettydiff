                ...
                do {
                    if (one[a] === two[b]) {
                        ...
                        if (table[one[a]].two === 0) {
                            c = a;
                            d = b;
                            if (a < len - 1 && table[one[a + 1]].one === 1 && table[one[a + 1]].two === 1) {
                                if (one[a + 1] === two[b]) {
                                ...
                                do {
                                    ...
                                    c += 1;
                                    d += 1;
                                } while (c < len && d < len && one[c] !== two[d] && table[one[c]].two === 0 && table[two[d]].one === 0);
                                fix(["replace", a, c, b, d]);
                                a = c - 1;
                                b = d - 1;
                            } else {
                            ...
                            c = a;
                            d = b;
                            if (d < len - 1 && table[two[b + 1]].one === 1 && table[two[b + 1]].two === 1) {
                                if (one[a] === two[b + 1]) {
                            ...
                            } else if (table[one[a]].two === 0) {
                                do {
                                    table[two[d]].two -= 1;
                                    if (table[two[d]].two < 1) {
                                        delete table[two[d]];
                                    }
                                    c += 1;
                                    d += 1;
                                } while (c < len && d < len && table[one[c]].two === 0 && table[two[d]].one === 0 && one[c] !== two[b]);
                                fix(["replace", a, c, b, d]);
                                a = c - 1;
                                b = d - 1;
                            } else {
                            ...
                            d = b;
                            e = b + 1;
                            do {console.log(table[one[c]]);
                                c += 1;
                            } while (c < len && one[c] !== two[e] && one[c] !== two[e + 1]);
                            e = a + 1;
                            do {
                                d += 1;
                            } while (d < len && one[e] !== two[d] && one[e + 1] !== two[d]);
                            e = c - a;
                            if (e === d - b) {
                                fix(["replace", a, c, b, d]);
                                do {
