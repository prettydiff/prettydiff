    ...
    var diffview = function diffview_(options) {
        ...
        var errorout      = 0,
            ...
            newTextArray  = (typeof options.diff === "string")
                ...
                : options.diff,
            opcodes = [],
            codeBuild = function diffview__opcodes(reverse) {
                var table = {},
                    ...
                    codes = [];
                if (reverse === true) {
                    one = (typeof options.diff === "string")
                        ? lines(options.diff)
                        : options.diff;
                    two = (typeof options.source === "string")
                ...
                a = 0;
                b = 0;
                len = Math.max(one.length, two.length);
                ...
                do {
                    if (one[a] === two[b]) {
                        ...
                        if (reverse === true) {
                            codes.push(["equal", b, b + (c - a), a, c]);
                        } else {
                            codes.push(["equal", a, c, b, b + (c - a)]);
                        }
                        b = b + (c - a) - 1;
                        a = c - 1;
                    } else {
                        if (table[one[a]].two === 0) {
                            c = a;
                            if (table[two[b]].one === 0) {
                                do {
                                    table[one[c]].one -= 1;
                                    ...
                                    c += 1;
                                } while (c < len && one[c] !== undefined && table[one[c]] !== undefined && two[b + (c - a)] !== undefined && table[one[c]].two === 0 && table[two[b + (c - a)]].one === 0 && one[c] !== two[b + (c - a)]);
                                if (codes.length > 0 && codes[codes.length - 1][0] === "replace") {
                                    if (reverse === true) {
                                        codes[codes.length - 1][4] = c;
                                        codes[codes.length - 1][2] = b + (c - a);
                                    } else {
                                        codes[codes.length - 1][2] = c;
                                        codes[codes.length - 1][4] = b + (c - a);
                                    }
                                } else {
                                    if (reverse === true) {
                                        codes.push(["replace", b, b + (c - a), a, c]);
                                    } else {
                                        codes.push(["replace", a, c, b, b + (c - a)]);
                                    }
                                }
                                b = b + (c - a) - 1;
                                a = c - 1;
                                ...
                                if (reverse === true) {
                                    codes.push(["insert", -1, -1, a, c]);
                                } else {
                                    codes.push(["delete", a, c, -1, -1]);
                                }
                                a = c - 1;
                                b -= 1;
                            }
                        } else if (table[two[b]].one === 0) {
                            c = b;
                            if (table[one[a]].two === 0) {
                                do {
                                    table[two[c]].two -= 1;
                                    ...
                                    c += 1;
                                } while (c < len && one[a + (c - b)] !== undefined && two[c] !== undefined && table[two[c]] !== undefined && table[one[a + (c - b)]].two === 0 && table[two[b]].one === 0 && one[a + (c - b)] !== two[b]);
                                if (codes.length > 0 && codes[codes.length - 1][0] === "replace") {
                                    if (reverse === true) {
                                        codes[codes.length - 1][4] = a + (c - b);
                                        codes[codes.length - 1][2] = c;
                                    } else {
                                        codes[codes.length - 1][2] = a + (c - b);
                                        codes[codes.length - 1][4] = c;
                                    }
                                } else {
                                    if (reverse === true) {
                                        codes.push(["replace", b, c, a, a + (c - b)]);
                                    } else {
                                        codes.push(["replace", a, a + (c - b), b, c]);
                                    }
                                }
                                a = a + (c - b) - 1;
                                b = c - 1;
                                ...
                                if (reverse === true) {
                                    codes.push(["delete", b, c, -1, -1]);
                                } else {
                                    codes.push(["insert", -1, -1, b, c]);
                                }
                                b = c - 1;
                                a -= 1;
                            }
                            ...
                            do {
                                ...
                                c += 1;
                            } while (c < len && table[one[c]].one > 0 && table[one[c]].two > 0);
                            if (codes.length > 0 && codes[codes.length - 1][0] === "replace") {
                                if (reverse === true) {
                                    codes[codes.length - 1][2] = c;
                                    codes[codes.length - 1][4] = b + (c - a);
                ...
                if (c - a === len - b && c - a > 0) {
                    if (one[a] === two[b]) {
                        if (codes[codes.length - 1][0] === "equal") {
                            if (reverse === true) {
                                codes[codes.length - 1][2] = c;
                                codes[codes.length - 1][4] = len;
                            } else {
                                codes[codes.length - 1][4] = c;
                                codes[codes.length - 1][2] = len;
                            }
                        } else {
                            if (reverse === true) {
                                codes.push(["equal", a, c, b, len]);
                            } else {
                                codes.push(["equal", b, len, a, c]);
                            }
                        }
                    } else {
                        if (codes[codes.length - 1][0] === "replace") {
                            if (reverse === true) {
                                codes[codes.length - 1][2] = c;
                                codes[codes.length - 1][4] = len;
                            } else {
                            ...
                            if (reverse === true) {
                                codes.push(["replace", b, len, a, c]);
                            } else {
                                codes.push(["replace", a, c, b, len]);
                            }
                        }
                    }
                } else if (a < c) {
                    if (reverse === true) {
                        codes.push(["delete", a - 1, c, -1, -1]);
                    } else {
                        codes.push(["insert", -1, -1, a - 1, c]);
                    }
                } else if (b < len) {
                    if (reverse === true) {
                        codes.push(["delete", b - 1, len, -1, -1]);
                    } else {
                        codes.push(["insert", -1, -1, b - 1, len]);
                    }
                }
                return codes;
            };
        ...
        opcodes = codeBuild(newTextArray.length > baseTextArray.length);
