...
(function () {
    ...
    var diffview = function diffview_(options) {
        ...
        (function diff_opcodes() {
            ...
            a = 0;
            b = 0;
            len = Math.max(onea.length, twoa.length);
            ...
            do {
                if (onea[a] === twoa[b]) {
                    ...
                    do {
                        table[onea[c]].one -= 1;
                        table[onea[c]].two -= 1;
                        if (table[onea[c]].one < 1 && table[onea[c]].two < 1) {
                            delete table[onea[c]];
                        }
                        c += 1;
                    ...
                    if (table[onea[a]].two === 0) {
                        ...
                        if (table[twoa[b]].one === 0) {
                            do {
                                table[onea[c]].one -= 1;
                                if (table[onea[c]].one < 1) {
                                    delete table[onea[c]];
                                }
                                c += 1;
                            } while (c < len && onea[c] !== undefined && table[onea[c]] !== undefined && twoa[b + (c - a)] !== undefined && table[onea[c]].two === 0 && table[twoa[b + (c - a)]].one === 0 && onea[c] !== twoa[b + (c - a)]);
                            if (opcodes.length > 0 && opcodes[opcodes.length - 1][0] === "replace") {
                                opcodes[opcodes.length - 1][2] = c;
                                opcodes[opcodes.length - 1][4] = b + (c - a);
                            } else {
                            ...
                            do {
                                ...
                                c += 1;
                            } while (c < len && onea[c] !== undefined && table[onea[c]] !== undefined && table[onea[c]].two === 0);
                            opcodes.push(["delete", a, c, -1, -1]);
                            a = c - 1;
                            b -= 1;
                        }
                        ...
                        if (table[onea[a]].two === 0) {
                            do {
                                table[twoa[c]].two -= 1;
                                if (table[twoa[c]].two < 1) {
                                    delete table[twoa[c]];
                                }
                                c += 1;
                            } while (c < len && onea[a + (c - b)] !== undefined && twoa[c] !== undefined && table[twoa[c]] !== undefined && table[onea[a + (c - b)]].two === 0 && table[twoa[b]].one === 0 && onea[a + (c - b)] !== twoa[b]);
                            if (opcodes.length > 0 && opcodes[opcodes.length - 1][0] === "replace") {
                                opcodes[opcodes.length - 1][2] = a + (c - b);
                                opcodes[opcodes.length - 1][4] = c;
                            } else {
                            ...
                            do {
                                ...
                                c += 1;
                            } while (c < len && twoa[c] !== undefined && table[twoa[c]] !== undefined && table[twoa[c]].one === 0);
                        ...
                        do {console.log(twoa[b]);
                            ...
                            c += 1;
                        } while (c < len && table[onea[c]].one > 0 && table[onea[c]].two > 0);
                        if (opcodes.length > 0 && opcodes[opcodes.length - 1][0] === "replace") {
                            opcodes[opcodes.length - 1][2] = c;
                            opcodes[opcodes.length - 1][4] = b + (c - a);
                        } else {
            ...
            if (c - a === len - b) {
                if (onea[a] === twoa[b]) {
                    if (opcodes[opcodes.length - 1][0] === "equal") {
                        opcodes[opcodes.length - 1][2] = c;
                        opcodes[opcodes.length - 1][4] = len;
                    } else {
                        opcodes.push(["equal", a, c, b, len]);
                    }
                } else {
                    if (opcodes[opcodes.length - 1][0] === "replace") {
                        opcodes[opcodes.length - 1][2] = c;
                        opcodes[opcodes.length - 1][4] = len;
                    } else {
                        opcodes.push(["replace", a, c, b, len]);
                    }
                }
            } else if (a < c) {
                opcodes.push(["delete", a - 1, c, -1, -1]);
            } else if (b < len) {
