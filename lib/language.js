...
global.prettydiff.language = {};
global.prettydiff.language.setlangmode = function language_setlangmode(input) {
    "use strict";
    var langmap = {
        coldfusion: "markup",
        css       : "css",
...
global.prettydiff.language.nameproper  = function language_nameproper(input) {
    "use strict";
    var langmap = {
...
global.prettydiff.language.auto = function language_auto(sample, defaultLang) {
    "use strict";
    var b         = [],
        c         = 0,
