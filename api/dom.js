...
/*global edition, document, localStorage, window, prettydiff, summary, markup_beauty, cleanCSS, csspretty, csvbeauty, csvmin, markupmin, jspretty, diffview, XMLHttpRequest, location, ActiveXObject, FileReader, navigator, setTimeout, codeMirror, AudioContext, ArrayBuffer, Uint8Array*/
/***********************************************************************
...
(function dom__init() {
    ...
    pd.colSliderGrab       = function dom__colSliderGrab(e) {
        var event       = e || window.event,
            touch       = (e.type === "touchstart") ? true : false,
            node        = this,
    ...
    (function dom__load() {
        var a           = 0,
            ...
            sequence = function dom__load_sequence(e) {
