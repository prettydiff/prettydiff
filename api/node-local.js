...
(function () {
    ...
    if (options.readmethod === "file") {
        ...
        if (options.jsscope === true && options.mode === "beautify") {
            fs.writeFile(options.output, reports(), function (err) {
                if (err) {
                    console.log("\nError writing report output.\n");
                    return console.log(err);
                }
        ...
        (function () {
            ...
            for (b = 0; b < a; b += 1) {
                ...
                if (g.test(source[b]) === true) {
                    ...
                    if (options.jsscope === true && options.mode === "beautify") {
                        fs.writeFileSync(options.output, reports(), "utf8");
                    } else {
                        report = reports();
