...
(function options_init() {
    ...
    (function options_build() {
        const defKeys:string[] = Object.keys(functions.definitions),
            len:number = defKeys.length;
        let a:number = 0;
        do {
            options[defKeys[a]] = functions.definitions[defKeys[a]].default;
            a = a + 1;
        } while (a < len);
    }());
