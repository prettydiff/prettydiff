...
(function options_init() {
    ...
    global.prettydiff.options = {
        functions: {
            ...
            consolePrint  : function options_consolePrint() {
            ...
            pdcomment     : function options_pdcomment() {
            ...
            validate      : function options_validate(api) {
            ...
            domops        : function options_domops(id, value, commentString) {
                var a    = 0,
                    data = [];
