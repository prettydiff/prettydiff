var exports = "",
    ...
    o = {
        au: $('ctype-auto'),
        ba: $('beau-tab').checked,
        bb: $('modebeautify').checked,
        bc: $('beau-char'),
        bd: $('Beautify'),
        bi: $('beautyinput'),
        bl: $('baselabel').value,
        bn: $('beau-line').checked,
        bo: $('baseText'),
        bq: $('beau-quan').value,
        bs: $('beau-space').checked,
        bt: $('diffBase'),
        bx: $('beautyoutput'),
        bw: $('beau-other'),
        bz: $('bo'),
        ...
        dc: $('diff-char'),
        dd: $('modediff').checked,
        dn: $('diffscolonn').checked,
        dq: $('diff-quan').value,
        ds: $('diff-space').checked,
        dt: $('difftall'),
        dw: $('diff-other'),
        dv: $('diffoutput'),
        dy: $('diffquoten').checked,
        dz: $('diff-line').checked,
        hd: $('htmld-yes').checked,
        hm: $('htmlm-yes').checked,
        ht: $('htmlspecific'),
        hy: $('html-yes').checked,
        id: $('inscriptd-yes').checked,
        is: $('inscript-yes').checked,
        iz: $('incomment-no').checked,
		jd: $('jsindentd-all').checked,
		js: $('jsindent-all').checked,
        md: $('Minify'),
        mi: $('minifyinput'),
        ml: $('minifyinputlines'),
        mm: $('modeminify').checked,
        mn: $('minifywindiff'),
        mo: $('minifyoutputsize'),
    ...
    recycle = function (x) {
        ...
        var lang = "auto",
            ...
            source,
            diffsource = "";
        o.bb = $('modebeautify').checked;
		o.jd = $('jsindentd-all').checked;
		o.js = $('jsindent-all').checked;
        o.ch = $('csvchar').value;
        o.cv = $('ctype-csv');
        o.dd = $('modediff').checked;
        o.mm = $('modeminify').checked;
        o.pt = $('ctype-text');
        ...
        if (o.bb === true) {
            o.hy = $('html-yes').checked;
            o.ba = $('beau-tab').checked;
            o.bn = $('beau-line').checked;
            o.bw = $('beau-other');
            o.bc = $('beau-char');
            o.bi = $('beautyinput');
            o.bq = $('beau-quan').value;
            o.bs = $('beau-space').checked;
            o.is = $('inscript-yes').checked;
            o.iz = $('incomment-no').checked;
            if (o.ba === true) {
                o.cz = "\t";
            } else if (o.bn === true) {
                o.cz = "\n";
            } else if (o.bw.checked === true) {
                o.cz = o.bc.value;
            } else {
                o.cz = " ";
            }
            if (Number(o.bq) === Number(o.bq)) {
                o.cn = Number(o.bq);
            }
            if (o.is !== true) {
                style = "noindent";
            ...
            o.context = $('contextSize').value;
            o.inline = $('inline').checked;
            o.bl = $('baselabel').value;
            o.nl = $('newlabel').value;
            o.hd = $('htmld-yes').checked;
            o.bo = $('baseText');
            o.nx = $('newText');
            o.dn = $('diffscolonn').checked;
            o.dy = $('diffquoten').checked;
            o.da = $('diff-tab');
            o.dw = $('diff-other');
            o.dz = $('diff-line').checked;
            o.dc = $('diff-char');
            o.dq = $('diff-quan').value;
            o.ds = $('diff-space').checked;
            o.id = $('inscriptd-yes').checked;
            o.ps = $('diff-save').checked;
            if (o.da === true) {
                o.cz = "\t";
            } else if (o.dz === true) {
                o.cz = "\n";
            } else if (o.dw.checked === true) {
                o.cz = o.dc.value;
            } else {
                o.cz = " ";
            }
            if (Number(o.dq) === Number(o.dq)) {
                o.cn = Number(o.dq);
            }
            if (o.is !== true) {
                style = "noindent";
            ...
            if (Number(o.context) !== Number(o.context)) {
                o.context = "";
            }
            if (o.ps === true) {
                publish = "webdownload";
            ...
            source = o.bo.value;
            diffsource = o.nx.value;
            mode = "diff";
        } else if (o.mm === true) {
            o.hm = $('htmlm-yes').checked;
            o.mi = $('minifyinput');
            if (o.hm === true) {
                html = true;
            }
        ...
        output = prettydiff(source, diffsource, mode, lang, o.ch, publish, o.cn, o.cz, comment, js, style, html, o.context, quote, semicolon, diffview, o.bl, o.nl, x);
        if (o.bb === true) {
            o.bx.value = output[0];
            o.dv.innerHTML = output[1];
        } else if (o.dd === true) {
            if (o.ps === true) {
        ...
        prettyvis:
            function (a) {
                ...
                case "modediff":
                    ...
                    break;
                case "diffwide":
                    o.bt.className = "diffwide";
                    o.nt.className = "diffwide";
                    o.bd.className = "wide";
                    o.md.className = "wide";
                    break;
                case "difftall":
            ...
            function (x) {
                "use strict";
                if (o.bb === true && x === "beau-char") {
                    o.bw.checked = true;
                } else if (o.dd === true && x === "diff-char") {
                    o.dw.checked = true;
                }
                if (o.bw.checked) {
